if (! function (t, e) {
        ...
        function l(t, e, i) {
            ...
            if (void 0 === i && 1 === t.nodeType)
                if (n = "data-" + e.replace(wt, "-$1").toLowerCase(), i = t.getAttribute(n), "string" == typeof i) {
                    try {
                        i = "true" === i ? !0 : "false" === i ? !1 : "null" === i ? null : +i + "" === i ? +i : bt.test(i) ? K.parseJSON(i) : i
                    } catch (o) {}
                    yt.set(t, e, i)
                } else i = void 0;
            return i
        ...
        function m(t, e) {
            var i, n, o, r, s, a, l, u;
            if (1 === e.nodeType) {
                if (vt.hasData(t) && (r = vt.access(t), s = vt.set(e, r), u = r.events)) {
                    delete s.handle, s.events = {};
                    for (o in u)
                        for (i = 0, n = u[o].length; n > i; i++) K.event.add(e, o, u[o][i])
                }
        ...
        function b(e, i) {
            var n, o = K(i.createElement(e)).appendTo(i.body),
                r = t.getDefaultComputedStyle && (n = t.getDefaultComputedStyle(o[0])) ? n.display : K.css(o[0], "display");
            return o.detach(), r
        }
        ...
        function w(t) {
            var e = Z,
                i = Wt[t];
            return i || (i = b(t, e), "none" !== i && i || (qt = (qt || K("<iframe frameborder='0' width='0' height='0'/>")).appendTo(e.documentElement), e = qt[0].contentDocument, e.write(), e.close(), i = b(t, e), qt.detach()), Wt[t] = i), i
        }

        function x(t, e, i) {
            var n, o, r, s, a = t.style;
            return i = i || Ht(t), i && (s = i.getPropertyValue(e) || i[e]), i && ("" !== s || K.contains(t.ownerDocument, t) || (s = K.style(t, e)), Rt.test(s) && Ft.test(e) && (n = a.width, o = a.minWidth, r = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = i.width, a.width = n, a.minWidth = o, a.maxWidth = r)), void 0 !== s ? s + "" : s
        }
        ...
        function k(t, e, i, n, o) {
            for (var r = i === (n ? "border" : "content") ? 4 : "width" === e ? 1 : 0, s = 0; 4 > r; r += 2) "margin" === i && (s += K.css(t, i + Ct[r], !0, o)), n ? ("content" === i && (s -= K.css(t, "padding" + Ct[r], !0, o)), "margin" !== i && (s -= K.css(t, "border" + Ct[r] + "Width", !0, o))) : (s += K.css(t, "padding" + Ct[r], !0, o), "padding" !== i && (s += K.css(t, "border" + Ct[r] + "Width", !0, o)));
            return s
        }
        ...
        function E(t, e) {
            for (var i, n, o, r = [], s = 0, a = t.length; a > s; s++) n = t[s], n.style && (r[s] = vt.get(n, "olddisplay"), i = n.style.display, e ? (r[s] || "none" !== i || (n.style.display = ""), "" === n.style.display && _t(n) && (r[s] = vt.access(n, "olddisplay", w(n.nodeName)))) : (o = _t(n), "none" === i && o || vt.set(n, "olddisplay", o ? i : K.css(n, "display"))));
        ...
        function j(t, e) {
            ...
            for (e = e ? 1 : 0; 4 > n; n += 2 - e) i = Ct[n], o["margin" + i] = o["padding" + i] = t;
        ...
        function N(t, e, i) {
            ...
            })), 1 === t.nodeType && ("height" in e || "width" in e) && (i.overflow = [p.overflow, p.overflowX, p.overflowY], u = K.css(t, "display"), c = "none" === u ? vt.get(t, "olddisplay") || w(t.nodeName) : u, "inline" === c && "none" === K.css(t, "float") && (p.display = "inline-block")), i.overflow && (p.overflow = "hidden", d.always(function () {
            ...
            for (n in e)
                if (o = e[n], Jt.exec(o)) {
                    ...
                    h[n] = g && g[n] || K.style(t, n)
                } else u = void 0;
            if (K.isEmptyObject(h)) "inline" === ("none" === u ? w(t.nodeName) : u) && (p.display = u);
            else {
                g ? "hidden" in g && (f = g.hidden) : g = vt.access(t, "fxshow", {}), r && (g.hidden = !f), f ? K(t).show() : d.done(function () {
                    K(t).hide()
                }), d.done(function () {
                    var e;
                    vt.remove(t, "fxshow");
                ...
                for (n in h) s = P(f ? g[n] : 0, n, d), n in g || (g[n] = s.start, f && (s.end = s.start, s.start = "width" === n || "height" === n ? 1 : 0))
            }
        }
        ...
        function D(t, e) {
            var i, n, o, r, s;
            for (i in t)
                if (n = K.camelCase(i), o = e[n], r = t[i], K.isArray(r) && (o = r[1], r = t[i] = r[0]), i !== n && (t[n] = r, delete t[i]), s = K.cssHooks[n], s && "expand" in s) {
        ...
        function M(t, e, i) {
            var n, o, r = 0,
                ...
                l = function () {
                    if (o) return !1;
                    for (var e = Ut || A(), i = Math.max(0, u.startTime + u.duration - e), n = i / u.duration || 0, r = 1 - n, s = 0, l = u.tweens.length; l > s; s++) u.tweens[s].run(r);
                ...
                c = u.props;
            for (D(c, u.opts.specialEasing); s > r; r++)
                if (n = ee[r].call(u, t, c, u.opts)) return n;
            return K.map(c, P, u), K.isFunction(u.opts.start) && u.opts.start.call(t, u), K.fx.timer(K.extend(l, {
                elem: t,
                anim: u,
                queue: u.opts.queue
        ...
        function W(t, e, i, n) {
            ...
            if (K.isArray(e)) K.each(e, function (e, o) {
                i || ke.test(t) ? n(t, o) : W(t + "[" + ("object" == typeof o ? e : "") + "]", o, i, n)
            });
        ...
        K.fn = K.prototype = {
            ...
            var t, e, i, n, o, r, s = arguments[0] || {},
                ...
                l = arguments.length,
                u = !1;
            for ("boolean" == typeof s && (u = s, s = arguments[a] || {}, a++), "object" == typeof s || K.isFunction(s) || (s = {}), a === l && (s = this, a--); l > a; a++)
                if (null != (t = arguments[a]))
                    for (e in t) i = s[e], n = t[e], s !== n && (u && n && (K.isPlainObject(n) || (o = K.isArray(n))) ? (o ? (o = !1, r = i && K.isArray(i) ? i : []) : r = i && K.isPlainObject(i) ? i : {}, s[e] = K.extend(u, r, n)) : void 0 !== n && (s[e] = n));
            return s
        }, K.extend({
            ...
            proxy: function (t, e) {
                var i, n, o;
                return "string" == typeof e && (i = t[e], e = t, t = i), K.isFunction(t) ? (n = H.call(arguments, 2), o = function () {
        ...
        var ot = function (t) {
            function e(t, e, i, n) {
                var o, r, s, a, l, u, d, p, f, g;
                if ((e ? e.ownerDocument || e : W) !== N && P(e), e = e || N, i = i || [], !t || "string" != typeof t) return i;
                ...
                if (M && !n) {
                    if (o = yt.exec(t))
                        if (s = o[1]) {
                            ...
                            } else if (e.ownerDocument && (r = e.ownerDocument.getElementById(s)) && $(e, r) && r.id === s) return i.push(r), i
                        } else {
                            if (o[2]) return K.apply(i, e.getElementsByTagName(t)), i;
                            if ((s = o[3]) && x.getElementsByClassName && e.getElementsByClassName) return K.apply(i, e.getElementsByClassName(s)), i
                        } if (x.qsa && (!z || !z.test(t))) {
                        if (p = d = q, f = e, g = 9 === a && t, 1 === a && "object" !== e.nodeName.toLowerCase()) {
                            for (u = k(t), (d = e.getAttribute("id")) ? p = d.replace(wt, "\\$&") : e.setAttribute("id", p), p = "[id='" + p + "'] ", l = u.length; l--;) u[l] = p + h(u[l]);
                            f = bt.test(t) && c(e.parentNode) || e, g = u.join(",")
                        }
                        if (g) try {
            ...
            function p(t, e, i) {
                ...
                return e.first ? function (e, i, r) {
                    ...
                    if (s) {
                        ...
                        for (; e = e[n];)
                            if (1 === e.nodeType || o) {
                                if (l = e[q] || (e[q] = {}), (a = l[n]) && a[0] === F && a[1] === r) return u[2] = a[2];
            ...
            function v(t, e, i, o, r, s) {
                return o && !o[q] && (o = v(o)), r && !r[q] && (r = v(r, s)), n(function (n, s, a, l) {
                    var u, c, d, h = [],
                        ...
                        b = i ? r || (n ? t : f || o) ? [] : s : y;
                    if (i && i(y, b, a, l), o)
                        for (u = m(b, p), o(u, [], a, l), c = u.length; c--;)(d = u[c]) && (b[p[c]] = !(y[p[c]] = d));
                    if (n) {
                        if (r || t) {
                            if (r) {
                            ...
                            for (c = b.length; c--;)(d = b[c]) && (u = r ? et.call(n, d) : h[c]) > -1 && (n[u] = !(s[u] = d))
                        }
            ...
            function y(t) {
                for (var e, i, n, o = t.length, r = C.relative[t[0].type], s = r || C.relative[" "], a = r ? 1 : 0, l = p(function (t) {
                        ...
                        return !r && (n || i !== O) || ((e = i).nodeType ? l(t, i, n) : u(t, i, n))
                    }]; o > a; a++)
                    if (i = C.relative[t[a].type]) c = [p(f(c), i)];
                        ...
                        if (i = C.filter[t[a].type].apply(null, t[a].matches), i[q]) {
                            ...
                            return v(a > 1 && f(c), a > 1 && h(t.slice(0, a - 1).concat({
                                value: " " === t[a - 2].type ? "*" : ""
                            })).replace(lt, "$1"), i, n > a && y(t.slice(a, n)), o > n && y(t = t.slice(n)), o > n && h(t))
                        }
                        c.push(i)
                    } return f(c)
            }
                ...
                var o = i.length > 0,
                    ...
                    s = function (n, s, a, l, u) {
                        var c, d, h, p = 0,
                            ...
                            x = b.length;
                        for (u && (O = s !== N && s); f !== x && null != (c = b[f]); f++) {
                            if (r && c) {
                                for (d = 0; h = t[d++];)
                                    if (h(c, s, a)) {
                                        l.push(c);
            ...
            var w, x, C, _, T, k, S, E, O, A, j, P, N, D, M, z, L, I, $, q = "sizzle" + -new Date,
                W = t.document,
                F = 0,
                R = 0,
                H = i(),
            ...
            x = e.support = {}, T = e.isXML = function (t) {
                ...
                var e, i = t ? t.ownerDocument || t : W,
                    n = i.defaultView;
                return i !== N && 9 === i.nodeType && i.documentElement ? (N = i, D = i.documentElement, M = !T(i), n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", function () {
                    P()
                    ...
                    return typeof e.getElementsByClassName !== X && M ? e.getElementsByClassName(t) : void 0
                }, L = [], z = [], (x.qsa = vt.test(i.querySelectorAll)) && (o(function (t) {
                ...
                })), (x.matchesSelector = vt.test(I = D.matches || D.webkitMatchesSelector || D.mozMatchesSelector || D.oMatchesSelector || D.msMatchesSelector)) && o(function (t) {
                    x.disconnectedMatch = I.call(t, "div"), I.call(t, "[s!='']:x"), L.push("!=", at)
                }), z = z.length && new RegExp(z.join("|")), L = L.length && new RegExp(L.join("|")), e = vt.test(D.compareDocumentPosition), $ = e || vt.test(D.contains) ? function (t, e) {
                    ...
                    return n ? n : (n = (t.ownerDocument || t) === (e.ownerDocument || e) ? t.compareDocumentPosition(e) : 1, 1 & n || !x.sortDetached && e.compareDocumentPosition(t) === n ? t === i || t.ownerDocument === W && $(W, t) ? -1 : e === i || e.ownerDocument === W && $(W, e) ? 1 : A ? et.call(A, t) - et.call(A, e) : 0 : 4 & n ? -1 : 1)
                } : function (t, e) {
                    if (t === e) return j = !0, 0;
                    var n, o = 0,
                        r = t.parentNode,
                        ...
                        l = [t],
                        u = [e];
                    if (!r || !a) return t === i ? -1 : e === i ? 1 : r ? -1 : a ? 1 : A ? et.call(A, t) - et.call(A, e) : 0;
                    if (r === a) return s(t, e);
                ...
                if ((t.ownerDocument || t) !== N && P(t), i = i.replace(dt, "='$1']"), !(!x.matchesSelector || !M || L && L.test(i) || z && z.test(i))) try {
                    var n = I.call(t, i);
                    if (n || x.disconnectedMatch || t.document && 11 !== t.document.nodeType) return n
                } catch (o) {}
                return e(i, N, null, [t]).length > 0
            }, e.contains = function (t, e) {
                return (t.ownerDocument || t) !== N && P(t), $(t, e)
            }, e.attr = function (t, e) {
                (t.ownerDocument || t) !== N && P(t);
                var i = C.attrHandle[e.toLowerCase()],
                    n = i && G.call(C.attrHandle, e.toLowerCase()) ? i(t, e, !M) : void 0;
                ...
                var e, i = [],
                    n = 0,
                    o = 0;
                if (j = !x.detectDuplicates, A = !x.sortStable && t.slice(0), t.sort(B), j) {
                ...
                filter: {
                        ...
                        return 1 === n && 0 === o ? function (t) {
                            ...
                            if (m) {
                                ...
                                if (f = [s ? m.firstChild : m.lastChild], s && y) {
                                    for (c = m[q] || (m[q] = {}), u = c[t] || [], p = u[0] === F && u[1], h = u[0] === F && u[2], d = p && m.childNodes[p]; d = ++p && d && d[g] || (h = p = 0) || f.pop();)
                                        if (1 === d.nodeType && ++h && d === e) {
                                            c[t] = [F, p, h];
                                            break
                                        }
                                } else if (y && (u = (e[q] || (e[q] = {}))[t]) && u[0] === F) h = u[1];
                                else
                                    for (;
                                        (d = ++p && d && d[g] || (h = p = 0) || f.pop()) && ((a ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++h || (y && ((d[q] || (d[q] = {}))[t] = [F, h]), d !== e)););
                    ...
                    PSEUDO: function (t, i) {
                        ...
                        return r[q] ? r(i) : r.length > 1 ? (o = [t, t, "", i], C.setFilters.hasOwnProperty(t.toLowerCase()) ? n(function (t, e) {
            ...
            return d.prototype = C.filters = C.pseudos, C.setFilters = new d, k = e.tokenize = function (t, i) {
                ...
                for (a = t, l = [], u = C.preFilter; a;) {
                    ...
                    for (s in C.filter) !(o = ft[s].exec(a)) || u[s] && !(o = u[s](o)) || (n = o.shift(), r.push({
                        value: n,
                        type: s,
                        matches: o
                    }), a = a.slice(n.length));
                ...
                var i, n = [],
                    ...
                    r = Q[t + " "];
                if (!r) {
                    for (e || (e = k(t)), i = e.length; i--;) r = y(e[i]), r[q] ? n.push(r) : o.push(r);
                ...
                if (i = i || [], 1 === d.length) {
                    if (r = d[0] = d[0].slice(0), r.length > 2 && "ID" === (s = r[0]).type && x.getById && 9 === e.nodeType && M && C.relative[r[1].type]) {
                        if (e = (C.find.ID(s.matches[0].replace(xt, Ct), e) || [])[0], !e) return i;
                        u && (e = e.parentNode), t = t.slice(r.shift().value.length)
                    }
                    for (o = ft.needsContext.test(t) ? 0 : r.length; o-- && (s = r[o], !C.relative[a = s.type]);)
                        if ((l = C.find[a]) && (n = l(s.matches[0].replace(xt, Ct), bt.test(r[0].type) && c(e.parentNode) || e))) {
                            if (r.splice(o, 1), t = n.length && h(r), !t) return K.apply(i, n), i;
                            break
                        }
                }
                return (u || S(t, d))(n, e, !M, i, bt.test(t) && c(e.parentNode) || e), i
            }, x.sortStable = q.split("").sort(B).join("") === q, x.detectDuplicates = !!j, P(), x.sortDetached = o(function (t) {
        ...
        K.extend({
            ...
            K.fn[t] = function (i, n) {
                ...
                return "Until" !== t.slice(-5) && (n = i), n && "string" == typeof n && (o = K.filter(n, o)), this.length > 1 && (ht[t] || K.unique(o), dt.test(t) && o.reverse()), this.pushStack(o)
            }
        });
        var pt = /\S+/g,
            ft = {};
        K.Callbacks = function (t) {
                ...
                d = {
                    add: function () {
                        if (l) {
                            ...
                            }(arguments), n ? s = l.length : e && (o = i, c(e))
                        }
                        return this
                    },
                    remove: function () {
            ...
            when: function (t) {
                var e, i, n, o = 0,
                    ...
                    u = function (t, i, n) {
                        return function (o) {
                            i[t] = this, n[t] = arguments.length > 1 ? H.call(arguments) : o, n === e ? l.notifyWith(i, n) : --a || l.resolveWith(i, n)
                        }
                    };
                if (s > 1)
                    for (e = new Array(s), i = new Array(s), n = new Array(s); s > o; o++) r[o] && K.isFunction(r[o].promise) ? r[o].promise().done(u(o, n, r)).fail(l.reject).progress(u(o, i, e)) : --a;
        ...
        var mt = K.access = function (t, e, i, n, o, r, s) {
            var a = 0,
                l = t.length,
                u = null == i;
            if ("object" === K.type(i)) {
                o = !0;
                for (a in i) K.access(t, e, a, i[a], !0, r, s)
            } else if (void 0 !== n && (o = !0, K.isFunction(n) || (s = !0), u && (s ? (e.call(t, n), e = null) : (u = e, e = function (t, e, i) {
                    return u.call(K(t), i)
                })), e))
        ...
        K.acceptData = function (t) {
            ...
            remove: function (t, e) {
                ...
                if (void 0 === e) this.cache[r] = {};
                    ...
                    K.isArray(e) ? n = e.concat(e.map(K.camelCase)) : (o = K.camelCase(e), e in s ? n = [e, o] : (n = o, n = n in s ? [n] : n.match(pt) || [])), i = n.length;
                    for (; i--;) delete s[n[i]]
                }
            },
            hasData: function (t) {
        ...
        ! function () {
            ...
            i.setAttribute("type", "radio"), i.setAttribute("checked", "checked"), i.setAttribute("name", "t"), e.appendChild(i), U.checkClone = e.cloneNode(!0).cloneNode(!0).lastChild.checked, e.innerHTML = "<textarea>x</textarea>", U.noCloneChecked = !!e.cloneNode(!0).lastChild.defaultValue
        }();
        var kt = "undefined";
        ...
        K.event = {
            ...
            add: function (t, e, i, n, o) {
                var r, s, a, l, u, c, d, h, p, f, g, m = vt.get(t);
                if (m)
                    for (i.handler && (r = i, i = r.handler, o = r.selector), i.guid || (i.guid = K.guid++), (l = m.events) || (l = m.events = {}), (s = m.handle) || (s = m.handle = function (e) {
                            return typeof K !== kt && K.event.triggered !== e.type ? K.event.dispatch.apply(t, arguments) : void 0
                        }), e = (e || "").match(pt) || [""], u = e.length; u--;) a = At.exec(e[u]) || [], p = g = a[1], f = (a[2] || "").split(".").sort(), p && (d = K.event.special[p] || {}, p = (o ? d.delegateType : d.bindType) || p, d = K.event.special[p] || {}, c = K.extend({
                        type: p,
                        origType: g,
                        data: n,
                        handler: i,
                        ...
                        namespace: f.join(".")
                    }, r), (h = l[p]) || (h = l[p] = [], h.delegateCount = 0, d.setup && d.setup.call(t, n, f, s) !== !1 || t.addEventListener && t.addEventListener(p, s, !1)), d.add && (d.add.call(t, c), c.handler.guid || (c.handler.guid = i.guid)), o ? h.splice(h.delegateCount++, 0, c) : h.push(c), K.event.global[p] = !0)
            },
            remove: function (t, e, i, n, o) {
                var r, s, a, l, u, c, d, h, p, f, g, m = vt.hasData(t) && vt.get(t);
                if (m && (l = m.events)) {
                    for (e = (e || "").match(pt) || [""], u = e.length; u--;)
                        if (a = At.exec(e[u]) || [], p = g = a[1], f = (a[2] || "").split(".").sort(), p) {
                            for (d = K.event.special[p] || {}, p = (n ? d.delegateType : d.bindType) || p, h = l[p] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = r = h.length; r--;) c = h[r], !o && g !== c.origType || i && i.guid !== c.guid || a && !a.test(c.namespace) || n && n !== c.selector && ("**" !== n || !c.selector) || (h.splice(r, 1), c.selector && h.delegateCount--, d.remove && d.remove.call(t, c));
                            s && !h.length && (d.teardown && d.teardown.call(t, f, m.handle) !== !1 || K.removeEvent(t, p, m.handle), delete l[p])
                        } else
            ...
            trigger: function (e, i, n, o) {
                var r, s, a, l, u, c, d, h = [n || Z],
                    p = G.call(e, "type") ? e.type : e,
                    f = G.call(e, "namespace") ? e.namespace.split(".") : [];
                if (s = a = n = n || Z, 3 !== n.nodeType && 8 !== n.nodeType && !Ot.test(p + K.event.triggered) && (p.indexOf(".") >= 0 && (f = p.split("."), p = f.shift(), f.sort()), u = p.indexOf(":") < 0 && "on" + p, e = e[K.expando] ? e : new K.Event(p, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = f.join("."), e.namespace_re = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), i = null == i ? [e] : K.makeArray(i, [e]), d = K.event.special[p] || {}, o || !d.trigger || d.trigger.apply(n, i) !== !1)) {
                    if (!o && !d.noBubble && !K.isWindow(n)) {
                        for (l = d.delegateType || p, Ot.test(l + p) || (s = s.parentNode); s; s = s.parentNode) h.push(s), a = s;
                        a === (n.ownerDocument || Z) && h.push(a.defaultView || a.parentWindow || t)
                    }
                    for (r = 0;
                        (s = h[r++]) && !e.isPropagationStopped();) e.type = r > 1 ? l : d.bindType || p, c = (vt.get(s, "events") || {})[e.type] && vt.get(s, "handle"), c && c.apply(s, i), c = u && s[u], c && c.apply && K.acceptData(s) && (e.result = c.apply(s, i), e.result === !1 && e.preventDefault());
                    return e.type = p, o || e.isDefaultPrevented() || d._default && d._default.apply(h.pop(), i) !== !1 || !K.acceptData(n) || u && K.isFunction(n[p]) && !K.isWindow(n) && (a = n[u], a && (n[u] = null), K.event.triggered = p, n[p](), K.event.triggered = void 0, a && (n[u] = a)), e.result
                }
            },
            dispatch: function (t) {
                t = K.event.fix(t);
                ...
                if (a[0] = t, t.delegateTarget = this, !u.preDispatch || u.preDispatch.call(this, t) !== !1) {
                    for (s = K.event.handlers.call(this, t, l), e = 0;
                        ...
                        for (t.currentTarget = o.elem, i = 0;
                            (r = o.handlers[i++]) && !t.isImmediatePropagationStopped();)(!t.namespace_re || t.namespace_re.test(r.namespace)) && (t.handleObj = r, t.data = r.data, n = ((K.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, a), void 0 !== n && (t.result = n) === !1 && (t.preventDefault(), t.stopPropagation()));
                ...
                if (a && l.nodeType && (!t.button || "click" !== t.type))
                    for (; l !== this; l = l.parentNode || this)
                        if (l.disabled !== !0 || "click" !== t.type) {
                            for (n = [], i = 0; a > i; i++) r = e[i], o = r.selector + " ", void 0 === n[o] && (n[o] = r.needsContext ? K(o, this).index(l) >= 0 : K.find(o, this, null, [l]).length), n[o] && n.push(r);
                            n.length && s.push({
                                elem: l,
                                handlers: n
                            })
            ...
            fix: function (t) {
                ...
                var e, i, n, o = t.type,
                    r = t,
                    s = this.fixHooks[o];
                for (s || (this.fixHooks[o] = s = Et.test(o) ? this.mouseHooks : St.test(o) ? this.keyHooks : {}), n = s.props ? this.props.concat(s.props) : this.props, t = new K.Event(r), e = n.length; e--;) i = n[e], t[i] = r[i];
            ...
            K.event.special[t] = {
                ...
                handle: function (t) {
                    var i, n = this,
                        o = t.relatedTarget,
                        r = t.handleObj;
                    return (!o || o !== n && !K.contains(n, o)) && (t.type = r.origType, i = r.handler.apply(this, arguments), t.type = e), i
                }
            }
        ...
        $t.optgroup = $t.option, $t.tbody = $t.tfoot = $t.colgroup = $t.caption = $t.thead, $t.th = $t.td, K.extend({
            clone: function (t, e, i) {
                ...
                if (!(U.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || K.isXMLDoc(t)))
            ...
            buildFragment: function (t, e, i, n) {
                for (var o, r, s, a, l, u, c = e.createDocumentFragment(), d = [], h = 0, p = t.length; p > h; h++)
                    if (o = t[h], o || 0 === o)
                        if ("object" === K.type(o)) K.merge(d, o.nodeType ? [o] : o);
                        else if (Nt.test(o)) {
                    for (r = r || c.appendChild(e.createElement("div")), s = (Pt.exec(o) || ["", ""])[1].toLowerCase(), a = $t[s] || $t._default, r.innerHTML = a[1] + o.replace(jt, "<$1></$2>") + a[2], u = a[0]; u--;) r = r.lastChild;
                    K.merge(d, r.childNodes), r = c.firstChild, r.textContent = ""
                } else d.push(e.createTextNode(o));
                for (c.textContent = "", h = 0; o = d[h++];)
                    if ((!n || -1 === K.inArray(o, n)) && (l = K.contains(o.ownerDocument, o), r = v(c.appendChild(o), "script"), l && g(r), i))
                        for (u = 0; o = r[u++];) zt.test(o.type || "") && i.push(o);
                return c
            },
            cleanData: function (t) {
                for (var e, i, n, o, r = K.event.special, s = 0; void 0 !== (i = t[s]); s++) {
                    if (K.acceptData(i) && (o = i[vt.expando], o && (e = vt.cache[o]))) {
                        if (e.events)
            ...
            html: function (t) {
                return mt(this, function (t) {
                    ...
                    if ("string" == typeof t && !Dt.test(t) && !$t[(Pt.exec(t) || ["", ""])[1].toLowerCase()]) {
                        t = t.replace(jt, "<$1></$2>");
                        try {
            ...
            domManip: function (t, e) {
                ...
                var i, n, o, r, s, a, l = 0,
                    ...
                    h = t[0],
                    g = K.isFunction(h);
                if (g || u > 1 && "string" == typeof h && !U.checkClone && Mt.test(h)) return this.each(function (i) {
                    var n = c.eq(i);
                    g && (t[0] = h.call(this, i, n.html())), n.domManip(t, e)
                });
                if (u && (i = K.buildFragment(t, this[0].ownerDocument, !1, this), n = i.firstChild, 1 === i.childNodes.length && (i = n), n)) {
                    for (o = K.map(v(i, "script"), p), r = o.length; u > l; l++) s = i, l !== d && (s = K.clone(s, !0, !0), r && K.merge(o, v(s, "script"))), e.call(this[l], s, l);
                    if (r)
                        for (a = o[o.length - 1].ownerDocument, K.map(o, f), l = 0; r > l; l++) s = o[l], zt.test(s.type || "") && !vt.access(s, "globalEval") && K.contains(a, s) && (s.src ? K._evalUrl && K._evalUrl(s.src) : K.globalEval(s.textContent.replace(It, "")))
                }
                return this
            }
        }), K.each({
            ...
            K.fn[t] = function (t) {
                for (var i, n = [], o = K(t), r = o.length - 1, s = 0; r >= s; s++) i = s === r ? this : this.clone(!0), K(o[s])[e](i), Q.apply(n, i.get());
        ...
        ! function () {
            ...
            s.style && (s.style.backgroundClip = "content-box", s.cloneNode(!0).style.backgroundClip = "", U.clearCloneStyle = "content-box" === s.style.backgroundClip, r.style.cssText = "border:0;width:0;height:0;top:0;left:-9999px;margin-top:1px;position:absolute", r.appendChild(s), t.getComputedStyle && K.extend(U, {
                ...
                reliableMarginRight: function () {
                    ...
                    return i.style.cssText = s.style.cssText = "-webkit-box-sizing:content-box;-moz-box-sizing:content-box;box-sizing:content-box;display:block;margin:0;border:0;padding:0", i.style.marginRight = i.style.width = "0", s.style.width = "1px", o.appendChild(r), e = !parseFloat(t.getComputedStyle(i, null).marginRight), o.removeChild(r), e
                }
            }))
        ...
        K.extend({
            ...
            css: function (t, e, i, n) {
                var o, r, s, a = K.camelCase(e);
                return e = K.cssProps[a] || (K.cssProps[a] = _(t.style, a)), s = K.cssHooks[e] || K.cssHooks[a], s && "get" in s && (o = s.get(t, !0, i)), void 0 === o && (o = x(t, e, n)), "normal" === o && e in Yt && (o = Yt[e]), "" === i || i ? (r = parseFloat(o), i === !0 || K.isNumeric(r) ? r || 0 : o) : o
            }
        }), K.each(["height", "width"], function (t, e) {
            K.cssHooks[e] = {
                get: function (t, i, n) {
                    return i ? Vt.test(K.css(t, "display")) && 0 === t.offsetWidth ? K.swap(t, Xt, function () {
                        return S(t, e, n)
                    }) : S(t, e, n) : void 0
                },
                set: function (t, i, n) {
                    var o = n && Ht(t);
                    return T(t, i, n ? k(t, e, n, "border-box" === K.css(t, "boxSizing", !1, o), o) : 0)
                }
            }
        }), K.cssHooks.marginRight = C(U.reliableMarginRight, function (t, e) {
            return e ? K.swap(t, {
            ...
            K.cssHooks[t + e] = {
                expand: function (i) {
                    for (var n = 0, o = {}, r = "string" == typeof i ? i.split(" ") : [i]; 4 > n; n++) o[t + Ct[n] + e] = r[n] || r[n - 2] || r[0];
                    return o
                }
            }, Ft.test(t) || (K.cssHooks[t + e].set = T)
        }), K.fn.extend({
            css: function (t, e) {
                return mt(this, function (t, e, i) {
                    var n, o, r = {},
                        s = 0;
                    if (K.isArray(e)) {
                        for (n = Ht(t), o = e.length; o > s; s++) r[e[s]] = K.css(t, e[s], !1, n);
                        return r
                    }
            ...
            init: function (t, e, i, n, o, r) {
                this.elem = t, this.prop = i, this.easing = o || "swing", this.options = e, this.start = this.now = this.cur(), this.end = n, this.unit = r || (K.cssNumber[i] ? "" : "px")
            },
            cur: function () {
            ...
            run: function (t) {
                ...
                return this.pos = e = this.options.duration ? K.easing[this.easing](t, this.options.duration * t, 0, 1, this.options.duration) : t, this.now = (this.end - this.start) * e + this.start, this.options.step && this.options.step.call(this.elem, this.now, this), i && i.set ? i.set(this) : O.propHooks._default.set(this), this
            }
        ...
        var Ut, Zt, Jt = /^(?:toggle|show|hide)$/,
            ...
            ie = {
                "*": [function (t, e) {
                    ...
                    if (s && s[3] !== r) {
                        r = r || s[3], o = o || [], s = +n || 1;
                        do a = a || ".5", s /= a, K.style(i.elem, t, s + r); while (a !== (a = i.cur() / n) && 1 !== a && --l)
                    }
        ...
        K.Animation = K.extend(M, {
                ...
                var t, e = 0,
                    i = K.timers;
                for (Ut = K.now(); e < i.length; e++) t = i[e], t() || i[e] !== t || i.splice(e--, 1);
            ...
            function () {
                ...
                t.type = "checkbox", U.checkOn = "" !== t.value, U.optSelected = i.selected, e.disabled = !0, U.optDisabled = !i.disabled, t = Z.createElement("input"), t.value = "t", t.type = "radio", U.radioValue = "t" === t.value
            }();
        ...
        K.fn.extend({
            ...
            attr: function (t, e, i) {
                ...
                return t && 3 !== r && 8 !== r && 2 !== r ? typeof t.getAttribute === kt ? K.prop(t, e, i) : (1 === r && K.isXMLDoc(t) || (e = e.toLowerCase(), n = K.attrHooks[e] || (K.expr.match.bool.test(e) ? oe : ne)), void 0 === i ? n && "get" in n && null !== (o = n.get(t, e)) ? o : (o = K.find.attr(t, e), null == o ? void 0 : o) : null !== i ? n && "set" in n && void 0 !== (o = n.set(t, i, e)) ? o : (t.setAttribute(e, i + ""), i) : void K.removeAttr(t, e)) : void 0
            },
            removeAttr: function (t, e) {
                var i, n, o = 0,
                    r = e && e.match(pt);
                if (r && 1 === t.nodeType)
                    for (; i = r[o++];) n = K.propFix[i] || i, K.expr.match.bool.test(i) && (t[n] = !1), t.removeAttribute(i)
            },
            attrHooks: {
                type: {
                    set: function (t, e) {
                        if (!U.radioValue && "radio" === e && K.nodeName(t, "input")) {
                            var i = t.value;
        ...
        K.fn.extend({
            ...
            prop: function (t, e, i) {
                ...
                return t && 3 !== s && 8 !== s && 2 !== s ? (r = 1 !== s || !K.isXMLDoc(t), r && (e = K.propFix[e] || e, o = K.propHooks[e]), void 0 !== i ? o && "set" in o && void 0 !== (n = o.set(t, i, e)) ? n : t[e] = i : o && "get" in o && null !== (n = o.get(t, e)) ? n : t[e]) : void 0
            },
            propHooks: {
                tabIndex: {
                    get: function (t) {
        ...
        K.fn.extend({
            ...
            toggleClass: function (t, e) {
                ...
                return "boolean" == typeof e && "string" === i ? e ? this.addClass(t) : this.removeClass(t) : this.each(K.isFunction(t) ? function (i) {
                    ...
                    if ("string" === i)
                        for (var e, n = 0, o = K(this), r = t.match(pt) || []; e = r[n++];) o.hasClass(e) ? o.removeClass(e) : o.addClass(e);
        ...
        K.fn.extend({
            val: function (t) {
                ...
                })) : o ? (e = K.valHooks[o.type] || K.valHooks[o.nodeName.toLowerCase()], e && "get" in e && void 0 !== (i = e.get(o, "value")) ? i : (i = o.value, "string" == typeof i ? i.replace(le, "") : null == i ? "" : i)) : void 0
            }
        }), K.extend({
            valHooks: {
                option: {
                ...
                select: {
                    get: function (t) {
                        for (var e, i, n = t.options, o = t.selectedIndex, r = "select-one" === t.type || 0 > o, s = r ? null : [], a = r ? o + 1 : n.length, l = 0 > o ? a : r ? o : 0; a > l; l++)
                            if (i = n[l], !(!i.selected && l !== o || (U.optDisabled ? i.disabled : null !== i.getAttribute("disabled")) || i.parentNode.disabled && K.nodeName(i.parentNode, "optgroup"))) {
                                if (e = K(i).val(), r) return e;
                                s.push(e)
                            } return s
                    },
                    set: function (t, e) {
                        for (var i, n, o = t.options, r = K.makeArray(e), s = o.length; s--;) n = o[s], (n.selected = K.inArray(n.value, r) >= 0) && (i = !0);
            ...
            }, U.checkOn || (K.valHooks[this].get = function (t) {
        ...
        try {
            ...
            he = Z.createElement("a"), he.href = "", he = he.href
        }
        de = be.exec(he.toLowerCase()) || [], K.extend({
            active: 0,
            lastModified: {},
            etag: {},
            ajaxSettings: {
            ...
            ajax: function (t, e) {
                function i(t, e, i, s) {
                    var l, c, v, y, w, C = e;
                    2 !== b && (b = 2, a && clearTimeout(a), n = void 0, r = s || "", x.readyState = t > 0 ? 4 : 0, l = t >= 200 && 300 > t || 304 === t, i && (y = $(d, x, i)), y = q(d, y, x, l), l ? (d.ifModified && (w = x.getResponseHeader("Last-Modified"), w && (K.lastModified[o] = w), w = x.getResponseHeader("etag"), w && (K.etag[o] = w)), 204 === t || "HEAD" === d.type ? C = "nocontent" : 304 === t ? C = "notmodified" : (C = y.state, c = y.data, v = y.error, l = !v)) : (v = C, (t || !C) && (C = "error", 0 > t && (t = 0))), x.status = t, x.statusText = (e || C) + "", l ? f.resolveWith(h, [c, C, x]) : f.rejectWith(h, [x, C, v]), x.statusCode(m), m = void 0, u && p.trigger(l ? "ajaxSuccess" : "ajaxError", [x, d, l ? c : v]), g.fireWith(h, [x, C]), u && (p.trigger("ajaxComplete", [x, d]), --K.active || K.event.trigger("ajaxStop")))
                }
                "object" == typeof t && (e = t, t = void 0), e = e || {};
                var n, o, r, s, a, l, u, c, d = K.ajaxSetup({}, e),
                    h = d.context || d,
                    p = d.context && (h.nodeType || h.jquery) ? K(h) : K.event,
                    f = K.Deferred(),
                    ...
                    x = {
                        ...
                        getResponseHeader: function (t) {
                            ...
                            if (2 === b) {
                                if (!s)
                                    for (s = {}; e = ge.exec(r);) s[e[1].toLowerCase()] = e[2];
                                e = s[t.toLowerCase()]
                            }
        ...
        K.param = function (t, e) {
            ...
            serializeArray: function () {
                return this.map(function () {
                    ...
                    var t = this.type;
                    return this.name && !K(this).is(":disabled") && Oe.test(this.nodeName) && !Ee.test(t) && (this.checked || !Tt.test(t))
                }).map(function (t, e) {
                    var i = K(this).val();
        ...
        }), U.cors = !!Ne && "withCredentials" in Ne, U.ajax = Ne = !!Ne, K.ajaxTransport(function (t) {
            var e;
            return U.cors || Ne && !t.crossDomain ? {
                send: function (i, n) {
                    var o, r = t.xhr(),
                        s = ++Ae;
                    ...
                    e = function (t) {
                        return function () {
                            e && (delete je[s], e = r.onload = r.onerror = null, "abort" === t ? r.abort() : "error" === t ? n(r.status, r.statusText) : n(Pe[r.status] || r.status, r.statusText, "string" == typeof r.responseText ? {
                                text: r.responseText
        ...
        K.ajaxSetup({
            ...
            return a || "jsonp" === e.dataTypes[0] ? (o = e.jsonpCallback = K.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, a ? e[a] = e[a].replace(Me, "$1" + o) : e.jsonp !== !1 && (e.url += (ce.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function () {
                return s || K.error(o + " was not called"), s[0]
            }, e.dataTypes[0] = "json", r = t[o], t[o] = function () {
                s = arguments
            }, n.always(function () {
                t[o] = r, e[o] && (e.jsonpCallback = i.jsonpCallback, De.push(o)), s && K.isFunction(r) && r(s[0]), s = r = void 0
            }), "script") : void 0
        ...
        K.fn.load = function (t, e, i) {
            ...
            var n, o, r, s = this,
                a = t.indexOf(" ");
            return a >= 0 && (n = K.trim(t.slice(a)), t = t.slice(0, a)), K.isFunction(e) ? (i = e, e = void 0) : e && "object" == typeof e && (o = "POST"), s.length > 0 && K.ajax({
                url: t,
                type: o,
                dataType: "html",
                data: e
        ...
        K.offset = {
            setOffset: function (t, e, i) {
                var n, o, r, s, a, l, u, c = K.css(t, "position"),
                    d = K(t),
                    h = {};
                "static" === c && (t.style.position = "relative"), a = d.offset(), r = K.css(t, "top"), l = K.css(t, "left"), u = ("absolute" === c || "fixed" === c) && (r + l).indexOf("auto") > -1, u ? (n = d.position(), s = n.top, o = n.left) : (s = parseFloat(r) || 0, o = parseFloat(l) || 0), K.isFunction(e) && (e = e.call(t, i, a)), null != e.top && (h.top = e.top - a.top + s), null != e.left && (h.left = e.left - a.left + o), "using" in e ? e.using.call(t, h) : d.css(h)
            }
        }, K.fn.extend({
            offset: function (t) {
                ...
                var e, i, n = this[0],
                    ...
                    r = n && n.ownerDocument;
                return r ? (e = r.documentElement, K.contains(e, n) ? (typeof n.getBoundingClientRect !== kt && (o = n.getBoundingClientRect()), i = F(r), {
            ...
            offsetParent: function () {
                return this.map(function () {
                    for (var t = this.offsetParent || Le; t && !K.nodeName(t, "html") && "static" === K.css(t, "position");) t = t.offsetParent;
                    return t || Le
                })
            }
        }), K.each({
            ...
            K.cssHooks[e] = C(U.pixelPosition, function (t, i) {
                return i ? (i = x(t, e), Rt.test(i) ? K(t).position()[e] + "px" : i) : void 0
            })
        }), K.each({
            Height: "height",
            Width: "width"
            ...
            K.each({
                ...
                K.fn[n] = function (n, o) {
                    ...
                    return mt(this, function (e, i, n) {
                        var o;
                        return K.isWindow(e) ? e.document.documentElement["client" + t] : 9 === e.nodeType ? (o = e.documentElement, Math.max(e.body["scroll" + t], o["scroll" + t], e.body["offset" + t], o["offset" + t], o["client" + t])) : void 0 === n ? K.css(e, i, s) : K.style(e, i, n, s)
                    }, e, r ? n : void 0, r, null)
                }
            })
        }), K.fn.size = function () {
        ...
        return K.noConflict = function (e) {
            return t.$ === K && (t.$ = $e), e && t.jQuery === K && (t.jQuery = Ie), K
...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
        ...
        easeInOutElastic: function (t, e, i, n, o) {
            ...
            return 1 > e ? -.5 * (a * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * o - r) * (2 * Math.PI) / s)) + i : a * Math.pow(2, -10 * (e -= 1)) * Math.sin((e * o - r) * (2 * Math.PI) / s) * .5 + n + i
        },
        ...
        if (!t.jQuery) {
            ...
            i.isWindow = function (t) {
                ...
                if (n) {
                    ...
                    for (r in t)
                        if (o = i.call(t[r], r, t[r]), o === !1) break;
                return t
                ...
                var t, e, n, o, r, s, a = arguments[0] || {},
                    ...
                    u = arguments.length,
                    c = !1;
                for ("boolean" == typeof a && (c = a, a = arguments[l] || {}, l++), "object" != typeof a && "function" !== i.type(a) && (a = {}), l === u && (a = this, l--); u > l; l++)
                    if (null != (r = arguments[l]))
                        for (o in r) t = a[o], n = r[o], a !== n && (c && n && (i.isPlainObject(n) || (e = i.isArray(n))) ? (e ? (e = !1, s = t && i.isArray(t) ? t : []) : s = t && i.isPlainObject(t) ? t : {}, a[o] = i.extend(c, s, n)) : void 0 !== n && (a[o] = n));
                return a
                ...
                if (t) {
                    n = (n || "fx") + "queue";
                    var s = i.data(t, n);
                    return o ? (!s || i.isArray(o) ? s = i.data(t, n, r(o)) : s.push(o), s) : s || []
                }
        ...
        return function (t, e, i, n) {
            ...
            function l(t, i, n, o) {
                ...
                function d() {
                    for (var e = 0; b > e; ++e) _[e] = l(e * w, t, n)
                }

                function h(e, i, o) {
                    var r, s, a = 0;
                    do s = i + (o - i) / 2, r = l(s, t, n) - e, r > 0 ? o = s : i = s; while (Math.abs(r) > v && ++a < y);
                    return s
                }

                function p(e) {
                    for (var i = 0, o = 1, r = b - 1; o != r && _[o] <= e; ++o) i += w;
                    --o;
                    var s = (e - _[o]) / (_[o + 1] - _[o]),
                        a = i + s * w,
                        l = u(a, t, n);
                    return l >= m ? c(e, a) : 0 == l ? a : h(e, i, i + w)
                }
            ...
            function u(t, e) {
                var i = t;
                return g.isString(t) ? b.Easings[t] || (i = !1) : i = g.isArray(t) && 1 === t.length ? a.apply(null, t) : g.isArray(t) && 2 === t.length ? w.apply(null, t.concat([e])) : g.isArray(t) && 4 === t.length ? l.apply(null, t) : !1, i === !1 && (i = b.Easings[b.defaults.easing] ? b.defaults.easing : y), i
            }
                ...
                if (t) {
                    ...
                    for (var r = 0; i > r; r++)
                        if (b.State.calls[r]) {
                            ...
                            for (var v = Math.min((e - p) / u.duration, 1), y = 0, w = l.length; w > y; y++) {
                                var C = l[y],
                                    T = C.element;
                                if (s(T)) {
                                    var k = !1;
                                    ...
                                    for (var E in C)
                                        if ("element" !== E) {
                                            var O, A = C[E],
                                                j = g.isString(A.easing) ? b.Easings[A.easing] : A.easing;
                                            if (1 === v) O = A.endValue;
                                            else {
                                                var P = A.endValue - A.startValue;
                                                if (O = A.startValue + P * j(v, u, P), !f && O === A.currentValue) continue
                                            }
                                            if (A.currentValue = O, "tween" === E) m = O;
                                            else {
                                                if (x.Hooks.registered[E]) {
                                                    var N = x.Hooks.getRoot(E),
                                                        D = s(T).rootPropertyValueCache[N];
                                                    D && (A.rootPropertyValue = D)
                                                }
                                                var M = x.setPropertyValue(T, E, A.currentValue + (0 === parseFloat(O) ? "" : A.unitType), A.rootPropertyValue, A.scrollData);
                                                x.Hooks.registered[E] && (s(T).rootPropertyValueCache[N] = x.Normalizations.registered[N] ? x.Normalizations.registered[N]("extract", null, M[1]) : M[1]), "transform" === M[0] && (k = !0)
                                            }
                                        } u.mobileHA && s(T).transformCache.translate3d === n && (s(T).transformCache.translate3d = "(0px, 0px, 0px)", k = !0), k && x.flushTransformCache(T)
                                }
                            }
                            u.display !== n && "none" !== u.display && (b.State.calls[r][2].display = !1), u.visibility !== n && "hidden" !== u.visibility && (b.State.calls[r][2].visibility = !1), u.progress && u.progress.call(a[1], a[1], v, Math.max(0, p + u.duration - e), p, m), 1 === v && d(r)
                        }
                }
            ...
            function d(t, e) {
                ...
                for (var i = b.State.calls[t][0], o = b.State.calls[t][1], r = b.State.calls[t][2], a = b.State.calls[t][4], l = !1, u = 0, c = i.length; c > u; u++) {
                    var d = i[u].element;
                    if (e || r.loop || ("none" === r.display && x.setPropertyValue(d, "display", r.display), "hidden" === r.visibility && x.setPropertyValue(d, "visibility", r.visibility)), r.loop !== !0 && (h.queue(d)[1] === n || !/\.velocityQueueEntryFlag/i.test(h.queue(d)[1])) && s(d)) {
                        s(d).isAnimating = !1, s(d).rootPropertyValueCache = {};
                        var p = !1;
                        h.each(x.Lists.transforms3D, function (t, e) {
                            var i = /^scale/.test(e) ? 1 : 0,
                                o = s(d).transformCache[e];
                            s(d).transformCache[e] !== n && new RegExp("^\\(" + i + "[^.]").test(o) && (p = !0, delete s(d).transformCache[e])
                        }), r.mobileHA && (p = !0, delete s(d).transformCache.translate3d), p && x.flushTransformCache(d), x.Values.removeClass(d, "velocity-animating")
                    }
                    ...
                    a && r.loop !== !0 && a(o), s(d) && r.loop === !0 && !e && (h.each(s(d).tweensContainer, function (t, e) {
                        /^rotate/.test(t) && 360 === parseFloat(e.endValue) && (e.endValue = 0,
                            e.startValue = 360), /^backgroundPosition/.test(t) && 100 === parseFloat(e.endValue) && "%" === e.unitType && (e.endValue = 0, e.startValue = 100)
                    }), b(d, "reverse", {
                        loop: !0,
                        delay: r.delay
            ...
            var h, p = function () {
                ...
                m = !1;
            if (t.fn && t.fn.jquery ? (h = t, m = !0) : h = e.Velocity.Utilities, 8 >= p && !m) throw new Error("Velocity: IE8 and below require jQuery to be loaded before Velocity.");
            ...
            var w = function () {
                ...
                return function n(t, e, o) {
                    var r, s, a, l = {
                        ...
                        d = 1e-4,
                        h = .016;
                    for (t = parseFloat(t) || 500, e = parseFloat(e) || 20, o = o || null, l.tension = t, l.friction = e, r = null !== o, r ? (c = n(t, e), s = c / o * h) : s = h; a = i(a || l, s), u.push(1 + a.x), c += 16, Math.abs(a.x) > d && Math.abs(a.v) > d;);
                    return r ? function (t) {
            ...
            var x = b.CSS = {
                                ...
                                switch (t) {
                                    ...
                                    case "extract":
                                        ...
                                        if (x.RegEx.wrappedValueAlreadyExtracted.test(o)) r = o;
                                            ...
                                            /^[A-z]+$/i.test(o) ? s = a[o] !== n ? a[o] : a.black : x.RegEx.isHex.test(o) ? s = "rgb(" + x.Values.hexToRgb(o).join(" ") + ")" : /^rgba?\(/i.test(o) || (s = a.black), r = (s || o).toString().match(x.RegEx.valueUnwrap)[1].replace(/,(\s+)?/g, " ")
                                        }
                ...
                getPropertyValue: function (t, i, o, r) {
                    function a(t, i) {
                        ...
                        if ("auto" === l && /^(top|right|bottom|left)$/i.test(i)) {
                            var g = a(t, "position");
                            ("fixed" === g || "absolute" === g && /top|left/i.test(i)) && (l = h(t).position()[i] + "px")
                        }
                        return l
                    }
                    var l;
                    if (x.Hooks.registered[i]) {
                        var u = i,
                            c = x.Hooks.getRoot(u);
                        o === n && (o = x.getPropertyValue(t, x.Names.prefixCheck(c)[0])), x.Normalizations.registered[c] && (o = x.Normalizations.registered[c]("extract", t, o)), l = x.Hooks.extractValue(u, o)
                    } else if (x.Normalizations.registered[i]) {
                        var d, f;
                        d = x.Normalizations.registered[i]("name", t), "transform" !== d && (f = a(t, x.Names.prefixCheck(d)[0]), x.Values.isCSSNullValue(f) && x.Hooks.templates[i] && (f = x.Hooks.templates[i][1])), l = x.Normalizations.registered[i]("extract", t, f)
                    }
                    if (!/^[\d-]/.test(l))
                ...
                setPropertyValue: function (t, i, n, o, r) {
                    ...
                    else if (x.Normalizations.registered[i] && "transform" === x.Normalizations.registered[i]("name", t)) x.Normalizations.registered[i]("inject", t, n), a = "transform", n = s(t).transformCache[i];
                    else {
                        if (x.Hooks.registered[i]) {
                            var l = i,
                                u = x.Hooks.getRoot(i);
                            o = o || x.getPropertyValue(t, u), n = x.Hooks.injectValue(l, n, o), i = u
                        }
                        if (x.Normalizations.registered[i] && (n = x.Normalizations.registered[i]("inject", t, n), i = x.Normalizations.registered[i]("name", t)), a = x.Names.prefixCheck(i)[0], 8 >= p) try {
                            t.style[a] = n
                        } catch (c) {
                            b.debug && console.log("Browser does not support [" + n + "] for [" + a + "]")
                        } else s(t) && s(t).isSVG && x.Names.SVGAttribute(i) ? t.setAttribute(i, n) : t.style[a] = n;
            ...
            x.Hooks.register(), x.Normalizations.register(), b.hook = function (t, e, i) {
                ...
                return t = r(t), h.each(t, function (t, r) {
                    if (s(r) === n && b.init(r), i === n) o === n && (o = b.CSS.getPropertyValue(r, e));
                    else {
            ...
            var C = function () {
                ...
                function o() {
                    function t(t) {
                        function d(t, e) {
                            var i = n,
                                o = n,
                                s = n;
                            return g.isArray(t) ? (i = t[0], !g.isArray(t[1]) && /^[\d-]/.test(t[1]) || g.isFunction(t[1]) || x.RegEx.isHex.test(t[1]) ? s = t[1] : (g.isString(t[1]) && !x.RegEx.isHex.test(t[1]) || g.isArray(t[1])) && (o = e ? t[1] : u(t[1], a.duration), t[2] !== n && (s = t[2]))) : i = t, e || (o = o || a.easing), g.isFunction(i) && (i = i.call(r, T, _)), g.isFunction(s) && (s = s.call(r, T, _)), [i || 0, o, s]
                        }
                        ...
                        function v() {
                            var t = {
                                ...
                                n = t.position === M.lastPosition && t.myParent === M.lastParent,
                                o = t.fontSize === M.lastFontSize;
                            M.lastParent = t.myParent, M.lastPosition = t.position, M.lastFontSize = t.fontSize;
                            var a = 100,
                                l = {};
                            if (o && n) l.emToPx = M.lastEmToPx, l.percentToPxWidth = M.lastPercentToPxWidth, l.percentToPxHeight = M.lastPercentToPxHeight;
                            else {
                                var u = s(r).isSVG ? i.createElementNS("http://www.w3.org/2000/svg", "rect") : i.createElement("div");
                                b.init(u), t.myParent.appendChild(u), h.each(["overflow", "overflowX", "overflowY"], function (t, e) {
                                    b.CSS.setPropertyValue(u, e, "hidden")
                                }), b.CSS.setPropertyValue(u, "position", t.position), b.CSS.setPropertyValue(u, "fontSize", t.fontSize), b.CSS.setPropertyValue(u, "boxSizing", "content-box"), h.each(["minWidth", "maxWidth", "width", "minHeight", "maxHeight", "height"], function (t, e) {
                                    b.CSS.setPropertyValue(u, e, a + "%")
                                }), b.CSS.setPropertyValue(u, "paddingLeft", a + "em"), l.percentToPxWidth = M.lastPercentToPxWidth = (parseFloat(x.getPropertyValue(u, "width", null, !0)) || 1) / a, l.percentToPxHeight = M.lastPercentToPxHeight = (parseFloat(x.getPropertyValue(u, "height", null, !0)) || 1) / a, l.emToPx = M.lastEmToPx = (parseFloat(x.getPropertyValue(u, "paddingLeft")) || 1) / a, t.myParent.removeChild(u)
                            }
                        ...
                        if ("scroll" === O) {
                            ...
                            if (!s(r).tweensContainer) return void h.dequeue(r, a.queue);
                            "none" === s(r).opts.display && (s(r).opts.display = "auto"), "hidden" === s(r).opts.visibility && (s(r).opts.visibility = "visible"), s(r).opts.loop = !1, s(r).opts.begin = null, s(r).opts.complete = null, y.easing || delete a.easing, y.duration || delete a.duration, a = h.extend({}, s(r).opts, a);
                            var P = h.extend(!0, {}, s(r).tweensContainer);
                            for (var N in P)
                                if ("element" !== N) {
                                    var D = P[N].startValue;
                                    P[N].startValue = P[N].currentValue = P[N].endValue, P[N].endValue = D, g.isEmptyObject(y) || (P[N].easing = a.easing), b.debug && console.log("reverse tweensContainer (" + N + "): " + JSON.stringify(P[N]), r)
                                } l = P
                        } else if ("start" === O) {
                            var P;
                            s(r).tweensContainer && s(r).isAnimating === !0 && (P = s(r).tweensContainer), h.each(m, function (t, e) {
                                if (RegExp("^" + x.Lists.colors.join("$|^") + "$").test(t)) {
                                    ...
                                    if (x.RegEx.isHex.test(o)) {
                                        for (var a = ["Red", "Green", "Blue"], l = x.Values.hexToRgb(o), u = s ? x.Values.hexToRgb(s) : n, c = 0; c < a.length; c++) {
                                            var h = [l[c]];
                                            r && h.push(r), u !== n && h.push(u[c]), m[t + a[c]] = h
                                        }
                                        delete m[t]
                                    }
                                }
                            ...
                            for (var L in m) {
                                ...
                                var F = x.Hooks.getRoot(L),
                                    R = !1;
                                if (s(r).isSVG || "tween" === F || x.Names.prefixCheck(F)[1] !== !1 || x.Normalizations.registered[F] !== n) {
                                    (a.display !== n && null !== a.display && "none" !== a.display || a.visibility !== n && "hidden" !== a.visibility) && /opacity|filter/.test(L) && !W && 0 !== $ && (W = 0), a._cacheValues && P && P[L] ? (W === n && (W = P[L].endValue + P[L].unitType), R = s(r).rootPropertyValueCache[F]) : x.Hooks.registered[L] ? W === n ? (R = x.getPropertyValue(r, F), W = x.getPropertyValue(r, L, R)) : R = x.Hooks.templates[F][1] : W === n && (W = x.getPropertyValue(r, L));
                                    var H, V, Q, B = !1;
                                    if (H = p(L, W), W = H[0], Q = H[1], H = p(L, $), $ = H[0].replace(/^([+-\/*])=/, function (t, e) {
                                            return B = e, ""
                                        }), V = H[1], W = parseFloat(W) || 0, $ = parseFloat($) || 0, "%" === V && (/^(fontSize|lineHeight)$/.test(L) ? ($ /= 100, V = "em") : /^scale/.test(L) ? ($ /= 100, V = "") : /(Red|Green|Blue)$/i.test(L) && ($ = $ / 100 * 255, V = "")), /[\/*]/.test(B)) V = Q;
                                    else if (Q !== V && 0 !== W)
                                        if (0 === $) V = Q;
                                        else {
                                            o = o || v();
                        ...
                        l.element && (x.Values.addClass(r, "velocity-animating"), z.push(l), "" === a.queue && (s(r).tweensContainer = l, s(r).opts = a), s(r).isAnimating = !0, T === _ - 1 ? (b.State.calls.push([z, f, a, null, E.resolver]), b.State.isTicking === !1 && (b.State.isTicking = !0, c())) : T++)
                    }
                    var o, r = this,
                        a = h.extend({}, b.defaults, y),
                        l = {};
                    switch (s(r) === n && b.init(r), parseFloat(a.delay) && a.queue !== !1 && h.queue(r, a.queue, function (t) {
                    ...
                    b.mock !== !1 && (b.mock === !0 ? a.duration = a.delay = 1 : (a.duration *= parseFloat(b.mock) || 1, a.delay *= parseFloat(b.mock) || 1)), a.easing = u(a.easing, a.duration), a.begin && !g.isFunction(a.begin) && (a.begin = null), a.progress && !g.isFunction(a.progress) && (a.progress = null), a.complete && !g.isFunction(a.complete) && (a.complete = null), a.display !== n && null !== a.display && (a.display = a.display.toString().toLowerCase(), "auto" === a.display && (a.display = b.CSS.Values.getDisplayType(r))), a.visibility !== n && null !== a.visibility && (a.visibility = a.visibility.toString().toLowerCase()), a.mobileHA = a.mobileHA && b.State.isMobile && !b.State.isGingerbread, a.queue === !1 ? a.delay ? setTimeout(t, a.delay) : t() : h.queue(r, a.queue, function (e, i) {
                        return i === !0 ? (E.promise && E.resolver(f), !0) : (b.velocityQueueEntryFlag = !0, void t(e))
                    }), "" !== a.queue && "fx" !== a.queue || "inprogress" === h.queue(r)[0] || h.dequeue(r)
                }
                var a, l, p, f, m, y, w = arguments[0] && (arguments[0].p || h.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || g.isString(arguments[0].properties));
                if (g.isWrapped(this) ? (a = !1, p = 0, f = this, l = this) : (a = !0, p = 1, f = w ? arguments[0].elements || arguments[0].e : arguments[0]), f = r(f)) {
                    ...
                    if (!/^(stop|finish)$/i.test(m) && !h.isPlainObject(y)) {
                        var k = p + 1;
                        y = {};
                        for (var S = k; S < arguments.length; S++) g.isArray(arguments[S]) || !/^(fast|normal|slow)$/i.test(arguments[S]) && !/^\d/.test(arguments[S]) ? g.isString(arguments[S]) || g.isArray(arguments[S]) ? y.easing = arguments[S] : g.isFunction(arguments[S]) && (y.complete = arguments[S]) : y.duration = arguments[S]
                    }
                    var E = {
                        promise: null,
                        resolver: null,
                    ...
                    a && b.Promise && (E.promise = new b.Promise(function (t, e) {
                        ...
                        case "stop":
                            ...
                            return h.each(b.State.calls, function (t, e) {
                                e && h.each(e[1], function (i, o) {
                                    var r = y === n ? "" : y;
                                    return r === !0 || e[2].queue === r || y === n && e[2].queue === !1 ? void h.each(f, function (i, n) {
                                        n === o && ((y === !0 || g.isString(y)) && (h.each(h.queue(n, g.isString(y) ? y : ""), function (t, e) {
                                            g.isFunction(e) && e(null, !0)
                                        }), h.queue(n, g.isString(y) ? y : "", [])), "stop" === m ? (s(n) && s(n).tweensContainer && r !== !1 && h.each(s(n).tweensContainer, function (t, e) {
                                            e.endValue = e.currentValue
                                        }), A.push(t)) : "finish" === m && (e[2].duration = 1))
                                    }) : !0
                                })
                            }), "stop" === m && (h.each(A, function (t, e) {
                                d(e, !0)
                            ...
                            if (!h.isPlainObject(m) || g.isEmptyObject(m)) {
                                if (g.isString(m) && b.Redirects[m]) {
                                    var j = h.extend({}, y),
                                        P = j.duration,
                                        N = j.delay || 0;
                                    return j.backwards === !0 && (f = h.extend(!0, [], f).reverse()), h.each(f, function (t, e) {
                                        parseFloat(j.stagger) ? j.delay = N + parseFloat(j.stagger) * t : g.isFunction(j.stagger) && (j.delay = N + j.stagger.call(e, t, _)), j.drag && (j.duration = parseFloat(P) || (/^(callout|transition)/.test(m) ? 1e3 : v), j.duration = Math.max(j.duration * (j.backwards ? 1 - t / _ : (t + 1) / _), .75 * j.duration, 200)), b.Redirects[m].call(e, e, j || {}, t, _, f, E.promise ? E : n)
                                    }), t()
                                }
                                var D = "Velocity: First argument (" + m + ") was not a property map, a known action, or a registered redirect. Aborting.";
                                return E.promise ? E.rejecter(new Error(D)) : console.log(D), t()
                            }
                            O = "start"
                    }
                    var M = {
                    ...
                    if (j.loop = parseInt(j.loop), L = 2 * j.loop - 1, j.loop)
                        for (var I = 0; L > I; I++) {
                            ...
                            I === L - 1 && ($.display = j.display, $.visibility = j.visibility, $.complete = j.complete), C(f, "reverse", $)
                        }
                    return t()
                }
            };
            b = h.extend(C, b), b.animate = C;
            var _ = e.requestAnimationFrame || f;
            return b.State.isMobile || i.hidden === n || i.addEventListener("visibilitychange", function () {
                i.hidden ? (_ = function (t) {
                    return setTimeout(function () {
                        t(!0)
                    }, 16)
                }, c()) : _ = e.requestAnimationFrame || f
        ...
        function k(t) {
            ...
            return new(e = i ? i : vt ? q : yt ? R : mt ? V : $)(t, S)
        }
        ...
        function S(t, e, i) {
            var n = i.pointers.length,
                ...
                r = e & Tt && 0 === n - o,
                s = e & (St | Et) && 0 === n - o;
            i.isFirst = !!r, i.isFinal = !!s, r && (t.session = {}), i.eventType = e, E(t, i), t.emit("hammer.input", i), t.recognize(i), t.session.prevInput = i
        }
        ...
        function E(t, e) {
            var i = t.session,
                n = e.pointers,
                o = n.length;
            i.firstInput || (i.firstInput = j(e)), o > 1 && !i.firstMultiple ? i.firstMultiple = j(e) : 1 === o && (i.firstMultiple = !1);
            var r = i.firstInput,
                s = i.firstMultiple,
                a = s ? s.center : r.center,
                l = e.center = P(n);
            e.timeStamp = pt(), e.deltaTime = e.timeStamp - r.timeStamp, e.angle = z(a, l), e.distance = M(a, l), O(i, e), e.offsetDirection = D(e.deltaX, e.deltaY), e.scale = s ? I(s.pointers, n) : 1, e.rotation = s ? L(s.pointers, n) : 0, A(i, e);
            var u = t.element;
        ...
        function O(t, e) {
            var i = e.center,
                ...
                o = t.prevDelta || {},
                r = t.prevInput || {};
            (e.eventType === Tt || r.eventType === St) && (o = t.prevDelta = {
                x: r.deltaX || 0,
                y: r.deltaY || 0
            }, n = t.offsetDelta = {
                x: i.x,
        ...
        function A(t, e) {
            ...
            if (e.eventType != Et && (l > _t || a.velocity === n)) {
                var u = a.deltaX - e.deltaX,
                    c = a.deltaY - e.deltaY,
                    d = N(l, u, c);
                o = d.x, r = d.y, i = ht(d.x) > ht(d.y) ? d.x : d.y, s = D(u, c), t.lastInterval = e
        ...
        function D(t, e) {
            return t === e ? Ot : ht(t) >= ht(e) ? t > 0 ? At : jt : e > 0 ? Pt : Nt
        }
        ...
        function L(t, e) {
            return z(e[1], e[0], It) - z(t[1], t[0], It)
        }

        function I(t, e) {
            return M(e[0], e[1], It) / M(t[0], t[1], It)
        }

        function $() {
            this.evEl = qt, this.evWin = Wt, this.allow = !0, this.pressed = !1, T.apply(this, arguments)
        }

        function q() {
            this.evEl = Ht, this.evWin = Vt, T.apply(this, arguments), this.store = this.manager.session.pointerEvents = []
        }

        function W() {
            this.evTarget = Bt, this.evWin = Xt, this.started = !1, T.apply(this, arguments)
        }

        function F(t, e) {
            var i = b(t.touches),
                n = b(t.changedTouches);
            return e & (St | Et) && (i = w(i.concat(n), "identifier", !0)), [i, n]
        }
        ...
        function H(t, e) {
            ...
            for (o = 0; o < s.length;) n[s[o].identifier] && a.push(s[o]), e & (St | Et) && delete n[s[o].identifier], o++;
        ...
        function V() {
            ...
            this.touch = new R(this.manager, t), this.mouse = new $(this.manager, t)
        }
        ...
        function X(t) {
            this.id = C(), this.manager = null, this.options = l(t || {}, this.defaults), this.options.enable = h(this.options.enable, !0), this.state = oe, this.simultaneous = {}, this.requireFail = []
        }

        function Y(t) {
            return t & ue ? "cancel" : t & ae ? "end" : t & se ? "move" : t & re ? "start" : ""
        }

        function G(t) {
            return t == Nt ? "down" : t == Pt ? "up" : t == At ? "left" : t == jt ? "right" : ""
        }
        ...
        function rt(t, e) {
            e = e || {}, this.options = l(e, ot.defaults), this.options.inputTarget = this.options.inputTarget || t, this.handlers = {}, this.session = {}, this.recognizers = [], this.element = t, this.input = k(this), this.touchAction = new Q(this, this.options.touchAction), st(this, !0), s(e.recognizers, function (t) {
        ...
        u($, T, {
            handler: function (t) {
                var e = $t[t.type];
                e & Tt && 0 === t.button && (this.pressed = !0), e & kt && 1 !== t.which && (e = St), this.pressed && this.allow && (e & St && (this.pressed = !1), this.callback(this.manager, e, {
                    pointers: [t],
                    changedPointers: [t],
                    pointerType: xt,
                    srcEvent: t
        ...
        t.MSPointerEvent && (Ht = "MSPointerDown", Vt = "MSPointerMove MSPointerUp MSPointerCancel"), u(q, T, {
            handler: function (t) {
                var e = this.store,
                    i = !1,
                ...
                o & Tt && (0 === t.button || s) ? 0 > a && (e.push(t), a = e.length - 1) : o & (St | Et) && (i = !0), 0 > a || (e[a] = t, this.callback(this.manager, o, {
                    pointers: e,
                    changedPointers: [t],
                    pointerType: r,
                    srcEvent: t
        ...
        u(W, T, {
            handler: function (t) {
                ...
                if (e === Tt && (this.started = !0), this.started) {
                    ...
                    e & (St | Et) && 0 === i[0].length - i[1].length && (this.started = !1), this.callback(this.manager, e, {
                        pointers: i[0],
                        changedPointers: i[1],
                        pointerType: bt,
                        srcEvent: t
        ...
        u(R, T, {
            ...
            handler: function (t, e, i) {
                ...
                e & (St | Et) && (this.mouse.allow = !0), this.callback(t, e, i)
            },
            destroy: function () {
            ...
            preventDefaults: function (t) {
                if (!Zt) {
                    ...
                    var n = this.actions,
                        ...
                        r = m(n, ne),
                        s = m(n, ie);
                    return o || r && i & Dt || s && i & Mt ? this.preventSrc(e) : void 0
                }
            },
        ...
        X.prototype = {
            ...
            recognize: function (t) {
                var e = a({}, t);
                return d(this.options.enable, [this, e]) ? (this.state & (le | ue | ce) && (this.state = oe), this.state = this.process(e), void(this.state & (re | se | ae | ue) && this.tryEmit(e))) : (this.reset(), void(this.state = ce))
            },
            process: function () {},
            ...
            process: function (t) {
                var e = this.state,
                    ...
                    n = e & (re | se),
                    o = this.attrTest(t);
                return n && (i & Et || !o) ? e | ue : n || o ? i & St ? e | ae : e & re ? e | se : re : ce
            }
        }), u(J, Z, {
            defaults: {
                event: "pan",
            ...
            getTouchAction: function () {
                var t = this.options.direction,
                    e = [];
                return t & Dt && e.push(ne), t & Mt && e.push(ie), e
            },
            directionTest: function (t) {
                var e = this.options,
                    ...
                    r = t.deltaX,
                    s = t.deltaY;
                return o & e.direction || (e.direction & Dt ? (o = 0 === r ? Ot : 0 > r ? At : jt, i = r != this.pX, n = Math.abs(t.deltaX)) : (o = 0 === s ? Ot : 0 > s ? Pt : Nt, i = s != this.pY, n = Math.abs(t.deltaY))), t.direction = o, i && n > e.threshold && o & e.direction
            },
            attrTest: function (t) {
            ...
            process: function (t) {
                ...
                if (this._input = t, !n || !i || t.eventType & (St | Et) && !r) this.reset();
                else if (t.eventType & Tt) this.reset(), this._timer = o(function () {
            ...
            attrTest: function (t) {
                ...
                return i & (Dt | Mt) ? e = t.velocity : i & Dt ? e = t.velocityX : i & Mt && (e = t.velocityY), this._super.attrTest.call(this, t) && i & t.direction && t.distance > this.options.threshold && ht(e) > this.options.velocity && t.eventType & St
            },
            emit: function (t) {
                var e = G(t.direction);
...
Vel = $ ? $.Velocity : jQuery ? jQuery.Velocity : Velocity,
    function (t) {
        t.fn.collapsible = function (e) {
            ...
            return e = t.extend(i, e), this.each(function () {
                ...
                var s = t(this),
                    a = t(this).find("> li > .collapsible-header"),
                    l = s.data("collapsible");
                s.off("click.collapse", "> li > .collapsible-header"), a.off("click.collapse"), s.on("click.collapse", "> li > .collapsible-header", function (s) {
                    var a = t(this),
                        u = t(s.target);
                    o(u) && (u = r(u)), u.toggleClass("active"), e.accordion || "accordion" === l || void 0 === l ? i(u) : (n(u), a.hasClass("active") && n(a))
                });
                var a = s.find("> li > .collapsible-header");
                e.accordion || "accordion" === l || void 0 === l ? i(a.filter(".active").first()) : a.filter(".active").each(function () {
                    n(t(this))
                })
            })
    ...
    function (t) {
        t.fn.scrollTo = function (e) {
            ...
            this.each(function () {
                ...
                function o(e) {
                    "focus" === e && (l = !0), n(), u.addClass("active"), s.addClass("active"), a.constrain_width === !0 ? u.css("width", s.outerWidth()) : u.css("white-space", "nowrap");
                    var i, o = window.innerHeight,
                        ...
                        h = a.alignment,
                        p = 0;
                    if (a.belowOrigin === !0 && (p = r), c + u.innerWidth() > t(window).width() ? h = "right" : c - u.innerWidth() + s.innerWidth() < 0 && (h = "left"), d + u.innerHeight() > o)
                        if (d + r - u.innerHeight() < 0) {
                            var f = o - d - p;
                            u.css("max-height", f)
                        } else p || (p += r), p -= u.innerHeight();
                    if ("left" === h) i = a.gutter, leftPosition = s.position().left + i;
                    else if ("right" === h) {
                        var g = s.position().left + s.outerWidth() - u.outerWidth();
                        i = -a.gutter, leftPosition = g + i
                    }
                    u.css({
                        position: "absolute",
                        top: s.position().top + p,
                        left: leftPosition
                ...
                function r() {
                    l = !1, u.fadeOut(a.outDuration), u.removeClass("active"), s.removeClass("active"), setTimeout(function () {
                        u.css("max-height", "")
                    }, a.outDuration)
                }
                var s = t(this),
                ...
                if (n(), s.after(u), a.hover) {
                    ...
                    s.unbind("click." + s.attr("id")), s.on("mouseenter", function (t) {
                        ...
                        var i = e.toElement || e.relatedTarget;
                        t(i).closest(".dropdown-button").is(s) || (u.stop(!0, !0), r(), c = !1)
                    })
                } else s.unbind("click." + s.attr("id")), s.bind("click." + s.attr("id"), function (e) {
                    l || (s[0] != e.currentTarget || s.hasClass("active") || 0 !== t(e.target).closest(".dropdown-content").length ? s.hasClass("active") && (r(), t(document).unbind("click." + u.attr("id") + " touchstart." + u.attr("id"))) : (e.preventDefault(), o("click")), u.hasClass("active") && t(document).bind("click." + u.attr("id") + " touchstart." + u.attr("id"), function (e) {
                        u.is(e.target) || s.is(e.target) || s.find(e.target).length || (r(), t(document).unbind("click." + u.attr("id") + " touchstart." + u.attr("id")))
                    }))
                });
        ...
        t.fn.extend({
            openModal: function (i) {
                ...
                var o = {
                    ...
                    r = n(),
                    s = t(this),
                    a = t('<div class="lean-overlay"></div>'),
                    l = ++e;
            ...
            closeModal: function (i) {
                var n = {
                    ...
                    r = o.data("overlay-id"),
                    s = t("#" + r);
                i = t.extend(n, i), t("body").css("overflow", ""), o.find(".modal-close").off("click.close"), t(document).off("keyup.leanModal" + r), s.velocity({
                    opacity: 0
                }, {
                    duration: i.out_duration,
                    queue: !1,
                    ease: "easeOutQuart"
                }), o.hasClass("bottom-sheet") ? o.velocity({
                    bottom: "-100%",
                    opacity: 0
                }, {
                    duration: i.out_duration,
                ...
                if (!t(this).hasClass("initialized")) {
                    ...
                    l.wrap(u), l.on("click", function () {
                        ...
                        for (r = !1, l.addClass("active"), o = !0, a.css({
                            ...
                            var p = t(n);
                            "hidden" === p.css("overflow") && (p.css("overflow", "visible"), i = void 0 === i ? p : i.add(p)), n = n.parentNode
                        }
                        l.css({
                            position: "absolute",
                            "z-index": 1e3
                        ...
                        if (t("body").append(f), f.velocity({
                            ...
                            g.text(l.data("caption")), t("body").append(g), g.css({
                                display: "inline"
                            }), g.velocity({
                                opacity: 1
                            }, {
                        ...
                        var m = 0,
                            ...
                            b = 0,
                            w = 0;
                        v > y ? (m = h / d, b = .9 * u, w = .9 * u * m) : (m = d / h, b = .9 * c * m, w = .9 * c), l.hasClass("responsive-img") ? l.velocity({
                            "max-width": b,
                            width: d
                        }, {
                            duration: 0,
            ...
            return this.each(function (i) {
                function n(i) {
                    ...
                    var r = o.children("img").first(),
                        ...
                        p = (h - u) / (n + d),
                        f = Math.round(a * p);
                    i && r.css("display", "block"), l > c && c + d > u && r.css("transform", "translate3D(-50%," + f + "px, 0)")
                }
                var o = t(this);
            ...
            init: function () {
                return this.each(function () {
                    ...
                    var i, n, o = e.find("li.tab a"),
                        ...
                        a = 0;
                    i = t(o.filter('[href="' + location.hash + '"]')), 0 === i.length && (i = t(this).find("li.tab a.active").first()), 0 === i.length && (i = t(this).find("li.tab a").first()), i.addClass("active"), a = o.index(i), 0 > a && (a = 0), n = t(i[0].hash), e.append('<div class="indicator"></div>');
                    ...
                    e.is(":visible") && (l.css({
                        ...
                        var c = a;
                        a = o.index(t(this)), 0 > a && (a = 0), n.show(), a - c >= 0 ? (l.velocity({
                            right: r - (a + 1) * s
                        }, {
                            duration: 300,
                            queue: !1,
    ...
    function (t) {
        t.fn.tooltip = function (i) {
            ...
            return "remove" === i ? (this.each(function () {
            ...
            }), !1) : (i = t.extend(o, i), this.each(function () {
                var o = Materialize.guid(),
                    r = t(this);
                r.attr("data-tooltip-id", o);
                var s = t("<span></span>").text(r.attr("data-tooltip")),
                    a = t("<div></div>");
                a.addClass("material-tooltip").append(s).appendTo(t("body")).attr("id", o);
                ...
                r.on({
                    "mouseenter.tooltip": function (t) {
                        var o = r.attr("data-delay");
                        o = void 0 === o || "" === o ? i.delay : o, u = setTimeout(function () {
                            c = !0, a.velocity("stop"), l.velocity("stop"), a.css({
                                display: "block",
                                left: "0px",
                                top: "0px"
                            }), a.children("span").text(r.attr("data-tooltip"));
                            var t, i, o, s = r.outerWidth(),
                                u = r.outerHeight(),
                                ...
                                g = "0px",
                                m = 8;
                            "top" === d ? (t = r.offset().top - h - n, i = r.offset().left + s / 2 - p / 2, o = e(i, t, p, h), f = "-10px", l.css({
                                borderRadius: "14px 14px 0 0",
                                transformOrigin: "50% 90%",
                                marginTop: h,
                                marginLeft: p / 2 - l.width() / 2
                            })) : "left" === d ? (t = r.offset().top + u / 2 - h / 2, i = r.offset().left - p - n, o = e(i, t, p, h), g = "-10px", l.css({
                                width: "14px",
                                height: "14px",
                                ...
                                marginTop: h / 2,
                                marginLeft: p
                            })) : "right" === d ? (t = r.offset().top + u / 2 - h / 2, i = r.offset().left + s + n, o = e(i, t, p, h), g = "+10px", l.css({
                                width: "14px",
                                height: "14px",
                                ...
                                marginTop: h / 2,
                                marginLeft: "0px"
                            })) : (t = r.offset().top + r.outerHeight() + n, i = r.offset().left + s / 2 - p / 2, o = e(i, t, p, h), f = "+10px", l.css({
                                marginLeft: p / 2 - l.width() / 2
                            })), a.css({
                                top: o.y,
                                left: o.x
                            }), m = p / 8, 8 > m && (m = 8), ("right" === d || "left" === d) && (m = p / 10, 6 > m && (m = 6)), a.velocity({
                                marginTop: f,
                                marginLeft: g
                            }, {
                                duration: 350,
                    ...
                    "mouseleave.tooltip": function () {
                        c = !1, clearTimeout(u), setTimeout(function () {
                            1 != c && (a.velocity({
                                ...
                                queue: !1,
                                complete: function () {
                                    l.css("display", "none"), a.css("display", "none"), c = !1
                                }
                            }))
                        }, 225)
                    }
        ...
        var a = a || {},
            ...
            u = {
                ...
                show: function (t, e) {
                    ...
                    "touches" in t && (a = t.touches[0].pageY - s.top, l = t.touches[0].pageX - s.left), r.setAttribute("data-hold", Date.now()), r.setAttribute("data-scale", c), r.setAttribute("data-x", l), r.setAttribute("data-y", a);
                    var d = {
                        top: a + "px",
                        left: l + "px"
                    };
        ...
        var e = {
            init: function (e) {
                ...
                e = t.extend(i, e), t(this).each(function () {
                    function i(i) {
                        s = !1, a = !1, t("body").css("overflow", ""), t("#sidenav-overlay").velocity({
                            opacity: 0
                        }, {
                            duration: 200,
                            queue: !1,
                    ...
                    t("body").append(r), "left" == e.edge ? (o.css("left", -1 * (e.menuWidth + 10)), r.css({
                        ...
                        window.innerWidth > 992 ? 0 !== t("#sidenav-overlay").css("opacity") && a ? i(!0) : (o.removeAttr("style"), o.css("width", e.menuWidth)) : a === !1 && ("left" === e.edge ? o.css("left", -1 * (e.menuWidth + 10)) : o.css("right", -1 * (e.menuWidth + 10)))
                    ...
                    r.on("click", function () {
                        ...
                        if ("touch" == n.gesture.pointerType) {
                            ...
                            if ("left" === e.edge && (r > e.menuWidth ? r = e.menuWidth : 0 > r && (r = 0)), "left" === e.edge) r < e.menuWidth / 2 ? a = !1 : r >= e.menuWidth / 2 && (a = !0), o.css("left", r - e.menuWidth);
                            else {
                                r < window.innerWidth - e.menuWidth / 2 ? a = !0 : r >= window.innerWidth - e.menuWidth / 2 && (a = !1);
                        ...
                        if ("touch" == i.gesture.pointerType) {
                            ...
                            s = !1, "left" === e.edge ? a && .3 >= n || -.5 > n ? (o.velocity({
                                left: 0
                            }, {
                                duration: 300,
                                queue: !1,
                                ...
                                right: 0,
                                left: ""
                            })) : (!a || n > .3) && (t("body").css("overflow", ""), o.velocity({
                                left: -1 * (e.menuWidth + 10)
                            }, {
                                duration: 200,
                                queue: !1,
                                ...
                                right: "",
                                left: 0
                            })) : (!a || -.3 > n) && (t("body").css("overflow", ""), o.velocity({
                                right: -1 * (e.menuWidth + 10)
                            }, {
                                duration: 200,
                                queue: !1,
    ...
    function (t) {
        ...
        function i() {
            ...
            var i = r.scrollTop(),
                ...
                o = n + r.width(),
                s = i + r.height(),
                l = e(i + c.top + 200, o + c.right, s + c.bottom, n + c.left);
        ...
        function o(t, e, i) {
            ...
            i || (i = {});
            var l = function () {
                a = i.leading === !1 ? 0 : d(), s = null, r = t.apply(n, o), n = o = null
            };
            return function () {
                var u = d();
                a || i.leading !== !1 || (a = u);
                var c = e - (u - a);
                return n = this, o = arguments, 0 >= c ? (clearTimeout(s), s = null, a = u, r = t.apply(n, o), n = o = null) : s || i.trailing === !1 || (s = setTimeout(l, c)), r
            }
        }
        var r = t(window),
            s = [],
        ...
        t.scrollSpy = function (e, n) {
            ...
            return t.winSizeSpy = function () {
                ...
                throttle: 100
            }, r.on("resize", o(n, e.throttle || 100))
    ...
    function (t) {
        t(document).ready(function () {
            ...
            t(o).each(function () {
                ...
                for (var e = t(this).closest(".file-field"), i = e.find("input.file-path"), n = t(this)[0].files, o = [], r = 0; r < n.length; r++) o.push(n[r].name);
            ...
            function i(t, e, i) {
                var o = t.indexOf(e),
                    r = -1 === o;
                return r ? t.push(e) : t.splice(o, 1), i.siblings("ul.dropdown-content").find("li").eq(e).toggleClass("active"), i.find("option").eq(e).prop("selected", r), n(t, i), r
            }
            ...
            t(this).each(function () {
                ...
                if (!n.hasClass("browser-default")) {
                        ...
                        t(this).click(function (s) {
                            if (!t(this).hasClass("disabled") && !t(this).hasClass("optgroup")) {
                                ...
                                o ? (t('input[type="checkbox"]', this).prop("checked", function (t, e) {
                                    return !e
                                }), a = i(c, t(this).index(), n), m.trigger("focus")) : (l.find("li").removeClass("active"), t(this).toggleClass("active"), m.val(t(this).text())), activateOption(l, t(this)), n.find("option").eq(r).prop("selected", a), n.trigger("change"), "undefined" != typeof e && e()
                            }
                            s.stopPropagation()
                        })
                    }), n.wrap(a);
                    ...
                    var g = h.replace(/"/g, "&quot;"),
                        m = t('<input type="text" class="select-dropdown" readonly="true" ' + (n.is(":disabled") ? "disabled" : "") + ' data-activates="select-options-' + s + '" value="' + g + '"/>');
                        ...
                        y = function (e) {
                            ...
                            if (13 != e.which || l.is(":visible")) {
                                ...
                                if (13 == e.which) {
                                    ...
                                    a && (t(a).trigger("click"), o || m.trigger("close"))
                                }
                                40 == e.which && (s = l.find("li.selected").length ? l.find("li.selected").next("li:not(.disabled)")[0] : l.find("li:not(.disabled)")[0], activateOption(l, s)), 27 == e.which && m.trigger("close"), 38 == e.which && (s = l.find("li.selected").prev("li:not(.disabled)")[0], s && activateOption(l, s)), setTimeout(function () {
                                    v = []
                                }, 1e3)
                            }
                        };
        ...
        var e = {
            init: function (e) {
                ...
                return e = t.extend(i, e), this.each(function () {
                    ...
                    function n(t) {
                        t >= u.length ? t = 0 : 0 > t && (t = u.length - 1), c = l.find(".active").index(), c != t && (o = u.eq(c), $caption = o.find(".caption"), o.removeClass("active"), o.velocity({
                            opacity: 0
                        }, {
                    ...
                    var o, r, s, a = t(this),
                        ...
                        u = l.find("li"),
                        c = l.find(".active").index(); - 1 != c && (o = u.eq(c)), a.hasClass("fullscreen") || (e.indicators ? a.height(e.height + 40) : a.height(e.height), l.height(e.height)), u.find(".caption").each(function () {
                        i(t(this), 0)
                        ...
                        o.click(function () {
                            var i = l.parent(),
                                o = i.find(t(this)).index();
                            n(o), clearInterval(s), s = setInterval(function () {
                                c = l.find(".active").index(), u.length == c + 1 ? c = 0 : c += 1, n(c)
                            }, e.transition + e.interval)
                        }), r.append(o)
                    }), a.append(r), r = a.find("ul.indicators").find("li.indicator-item")), o ? o.show() : (u.first().addClass("active").velocity({
                        opacity: 1
                    }, {
                        duration: e.transition,
                        queue: !1,
                        easing: "easeOutQuad"
                    }), c = 0, o = u.eq(c), e.indicators && r.eq(c).addClass("active")), o.find("img").each(function () {
                    ...
                    a.hammer({
                        ...
                        if ("touch" === t.gesture.pointerType) {
                            ...
                            $curr_slide = l.find(".active"), $curr_slide.velocity({
                                ...
                                queue: !1,
                                easing: "easeOutQuad"
                            }), 4 === e && (i > a.innerWidth() / 2 || -.65 > n) ? p = !0 : 2 === e && (i < -1 * a.innerWidth() / 2 || n > .65) && (h = !0);
                            var o;
                            h && (o = $curr_slide.next(), 0 === o.length && (o = u.first()), o.velocity({
                                opacity: 1
                            }, {
                                duration: 300,
                                queue: !1,
                                easing: "easeOutQuad"
                            })), p && (o = $curr_slide.prev(), 0 === o.length && (o = u.last()), o.velocity({
                                opacity: 1
                            }, {
                                duration: 300,
                                queue: !1,
                        ...
                        "touch" === t.gesture.pointerType && ($curr_slide = l.find(".active"), d = !1, curr_index = l.find(".active").index(), p || h ? h ? (n(curr_index + 1), $curr_slide.velocity({
                            ...
                            queue: !1,
                            easing: "easeOutQuad"
                        }), h = !1, p = !1, clearInterval(s), s = setInterval(function () {
                            c = l.find(".active").index(), u.length == c + 1 ? c = 0 : c += 1, n(c)
                        }, e.transition + e.interval))
            ...
            t(".dismissable").each(function () {
                t(this).hammer({
                    ...
                    if (Math.abs(n.gesture.deltaX) < t(this).innerWidth() / 2 && (i = !1, e = !1), "touch" === n.gesture.pointerType) {
                        ...
                        if (e || i) {
                            var r;
                            r = e ? o.innerWidth() : -1 * o.innerWidth(), o.velocity({
                                translateX: r
                            }, {
                                duration: 100,
                                queue: !1,
    ...
    function (t) {
        ...
        function e(r, s, l, d) {
            ...
            function p() {
                C.data(s, T).addClass(x.input).attr("tabindex", -1).val(C.data("value") ? T.get("select", w.format) : r.value), w.editable || C.on("focus." + b.id + " click." + b.id, function (t) {
                    t.preventDefault(), T.$root[0].focus()
                }).on("keydown." + b.id, m), o(r, {
                    haspopup: !0,
                    expanded: !1,
                    readonly: !1,
                    owns: r.id + "_root"
            ...
            function f() {
                T.$root.on({
                    ...
                    var e = t(this),
                        ...
                        o = a();
                    o = o && (o.type || o.href), (n || o && !t.contains(T.$root[0], o)) && T.$root[0].focus(), !n && i.nav ? T.set("highlight", T.component.item.highlight, {
                        nav: i.nav
            ...
            var y = !1,
                ...
                T = _.prototype = {
                    ...
                    $node: C,
                    start: function () {
                        return b && b.start ? T : (b.methods = {}, b.start = !0, b.open = !1, b.type = r.type, r.autofocus = r == a(), r.readOnly = !w.editable, r.id = r.id || b.id, "text" != r.type && (r.type = "text"), T.component = new l(T, w), T.$root = t(e._.node("div", h(), x.picker, 'id="' + r.id + '_root" tabindex="0"')), f(), w.formatSubmit && g(), p(), w.container ? t(w.container).append(T.$root) : C.after(T.$root), T.on({
                    ...
                    stop: function () {
                        return b.start ? (T.close(), T._hidden && T._hidden.parentNode.removeChild(T._hidden), T.$root.remove(), C.removeClass(x.input).removeData(s), setTimeout(function () {
                            C.off("." + b.id)
                        }, 0), r.type = b.type, r.readOnly = !1, T.trigger("stop"), b.methods = {}, b.start = !1, T) : T
                    },
                    open: function (i) {
                        return b.open ? T : (C.addClass(x.active), o(r, "expanded", !0), setTimeout(function () {
                            T.$root.addClass(x.opened), o(T.$root[0], "hidden", !1)
                        }, 0), i !== !1 && (b.open = !0, y && c.css("overflow", "hidden").css("padding-right", "+=" + n()), T.$root[0].focus(),
                            u.on("click." + b.id + " focusin." + b.id, function (t) {
                                var e = t.target;
                                ...
                                var n = i.keyCode,
                                    o = T.component.key[n],
                                    r = i.target;
                                27 == n ? T.close(!0) : r != T.$root[0] || !o && 13 != n ? t.contains(T.$root[0], r) && 13 == n && (i.preventDefault(), r.click()) : (i.preventDefault(), o ? e._.trigger(T.component.key.go, T, [e._.trigger(o)]) : T.$root.find("." + x.highlighted).hasClass(x.disabled) || T.set("select", T.component.item.highlight).close())
                            })), T.trigger("open"))
                    },
                    close: function (t) {
                        return t && (T.$root.off("focus.toOpen")[0].focus(), setTimeout(function () {
                            T.$root.on("focus.toOpen", v)
                        }, 0)), C.removeClass(x.active), o(r, "expanded", !1), setTimeout(function () {
                            T.$root.removeClass(x.opened + " " + x.focused), o(T.$root[0], "hidden", !0)
                    ...
                    set: function (e, i, n) {
                        ...
                        if (n = s && t.isPlainObject(i) ? i : n || {}, e) {
                            s || (a[e] = i);
                            for (o in a) r = a[o], o in T.component.item && (void 0 === r && (r = null), T.component.set(o, r, n)), ("select" == o || "clear" == o) && C.val("clear" == o ? "" : T.get(o, w.format)).trigger("change");
                            T.render()
                        }
                        return n.muted ? T : T.trigger("set", a)
                    },
                    get: function (t, i) {
    ...
    function (t) {
        ...
        i.prototype.set = function (t, e, i) {
            ...
            var o, r, s, a, l = e.isArray(i),
                ...
                c = this.item.view;
            if (l || u) {
                for (u ? (r = i.year, s = i.month, a = i.date) : (r = +i[0], s = +i[1], a = +i[2]), n && n.nav && c && c.month !== s && (r = c.year, s = c.month), o = new Date(r, s + (n && n.nav ? n.nav : 0), 1), r = o.getFullYear(), s = o.getMonth(); new Date(r, s, a).getMonth() !== s;) a -= 1;
                i = [r, s, a]
            }
            return i
            ...
            var o, s, a, l, u = this,
                ...
                p = u.item.min,
                f = u.item.max,
                g = h && u.item.disable.filter(function (t) {
                    if (e.isArray(t)) {
            ...
            if ((!n || !n.nav) && (!h && u.disabled(i) || h && u.disabled(i) && (g || o || s) || !h && (i.pick <= p.pick || i.pick >= f.pick)))
                for (h && !g && (!s && d > 0 || !o && 0 > d) && (d *= -1); u.disabled(i) && (Math.abs(d) > 1 && (i.month < c.month || i.month > c.month) && (i = c, d = d > 0 ? 1 : -1), i.pick <= p.pick ? (a = !0, d = 1, i = u.create([p.year, p.month, p.date + (i.pick === p.pick ? 0 : -1)])) : i.pick >= f.pick && (l = !0, d = -1, i = u.create([f.year, f.month, f.date + (i.pick === f.pick ? 0 : 1)])), !a || !l);) i = u.create([i.year, i.month, i.date + d]);
            return i
            ...
            return e && "string" == typeof e ? (i && i.format || (i = i || {}, i.format = n.settings.format), n.formats.toArray(i.format).map(function (t) {
                var i = n.formats[t],
                    s = i ? r.trigger(i, n, [e, o]) : t.replace(/^!/, "").length;
            ...
            var e = this,
                ...
                g = function (t) {
                    return r.node("div", " ", i.klass["nav" + (t ? "Next" : "Prev")] + (t && c.year >= p.year && c.month >= p.month || !t && c.year <= h.year && c.month <= h.month ? " " + i.klass.navDisabled : ""), "data-nav=" + (t || -1) + " " + r.ariaAttr({
                        role: "button",
                ...
                m = function (n) {
                    ...
                    return "short_months" == n && (o = i.monthsShort), i.selectMonths && void 0 == n ? r.node("select", r.group({
                        ...
                        node: "option",
                        item: function (t) {
                            return [o[t], 0, "value=" + t + (c.month == t ? " selected" : "") + (c.year == h.year && t < h.month || c.year == p.year && t > p.month ? " disabled" : "")]
                        }
                    }), i.klass.selectMonth + " browser-default", (t ? "" : "disabled") + " " + r.ariaAttr({
                        controls: e.$node[0].id + "_table"
                    }) + ' title="' + i.labelMonthSelect + '"') : "short_months" == n ? null != l ? r.node("div", o[l.month]) : r.node("div", o[c.month]) : r.node("div", o[c.month], i.klass.month)
                },
                v = function (n) {
                    var o = c.year,
            ...
            return createDayLabel = function () {
                ...
                return e
            }, r.node("div", r.node("div", createWeekdayLabel(), "picker__weekday-display") + r.node("div", m("short_months"), i.klass.month_display) + r.node("div", createDayLabel(), i.klass.day_display) + r.node("div", v("raw"), i.klass.year_display), i.klass.date_display) + r.node("div", r.node("div", (i.selectYears ? m() + v() : m() + v()) + g() + g(1), i.klass.header) + r.node("table", f + r.node("tbody", r.group({
                min: 0,
                max: o - 1,
                i: 1,
                node: "tr",
                item: function (t) {
                    var o = i.firstDay && 0 === e.create([c.year, c.month, 1]).day ? -7 : 0;
                    return [r.group({
                        min: n * t - c.day + o + 1,
                        max: function () {
                            return this.min + n - 1
                        ...
                        item: function (t) {
                            ...
                            var n = l && l.pick == t.pick,
                                o = u && u.pick == t.pick,
                                s = d && e.disabled(t) || t.pick < h.pick || t.pick > p.pick,
                                f = r.trigger(e.formats.toString, e, [i.format, t]);
                            return [r.node("div", t.date, function (e) {
                                return e.push(c.month == t.month ? i.klass.infocus : i.klass.outfocus), a.pick == t.pick && e.push(i.klass.now), n && e.push(i.klass.selected), o && e.push(i.klass.highlighted), s && e.push(i.klass.disabled), e.join(" ")
                ...
                readonly: !0
            })), i.klass.calendar_container) + r.node("div", r.node("button", i.today, "btn-flat picker__today", "type=button data-pick=" + a.pick + (t && !e.disabled(a) ? "" : " disabled") + " " + r.ariaAttr({
                controls: e.$node[0].id
    ...
    function (t) {
        var e = {
            init: function (e) {
                ...
                return e = t.extend(i, e), this.each(function () {
                    function i() {
                        "undefined" != typeof window.ontouchstart && (P[0].addEventListener("touchstart", c), P[0].addEventListener("touchmove", d), P[0].addEventListener("touchend", h)), P[0].addEventListener("mousedown", c), P[0].addEventListener("mousemove", d), P[0].addEventListener("mouseup", h), P[0].addEventListener("click", u)
                    }
                    ...
                    function u(i) {
                        ...
                        if (!e.full_width) {
                            var n = t(i.target).closest(".carousel-item").index(),
                                o = g % b - n;
                            0 > o ? Math.abs(o + b) < Math.abs(o) && (o += b) : o > 0 && Math.abs(o - b) < o && (o -= b), 0 > o ? t(this).trigger("carouselNext", [Math.abs(o)]) : o > 0 && t(this).trigger("carouselPrev", [o])
                        }
                    }

                    function c(t) {
                        m = !0, A = !1, j = !1, w = n(t), x = o(t), T = C = 0, S = f, E = Date.now(), clearInterval(O), O = setInterval(a, 100)
                    }

                    function d(t) {
                        var e, i, r;
                        if (m)
                            if (e = n(t), y = o(t), i = w - e, r = Math.abs(x - y), 30 > r && !j)(i > 2 || -2 > i) && (A = !0, w = e, s(f + i));
                            else {
                    ...
                    function h(t) {
                        return m = !1, clearInterval(O), _ = f, (T > 10 || -10 > T) && (C = .9 * T, _ = f + C), _ = Math.round(_ / v) * v, C = _ - f, E = Date.now(), requestAnimationFrame(l), t.preventDefault(), t.stopPropagation(), !1
                    }
                    var p, f, g, m, v, b, w, x, C, _, T, k, S, E, O, A, j, P = t(this);
                    return P.hasClass("initialized") ? !0 : (e.full_width && (e.dist = 0, imageHeight = P.find(".carousel-item img").first().load(function () {
                        P.css("height", t(this).height())
                    })), P.addClass("initialized"), m = !1, f = _ = 0, p = [], item_width = P.find(".carousel-item").first().innerWidth(), v = 2 * item_width + e.padding, P.find(".carousel-item").each(function () {
                        p.push(t(this)[0])
                    }), b = p.length, k = "transform", ["webkit", "Moz", "O", "ms"].every(function (t) {
                        var e = t + "Transform";
                        return "undefined" != typeof document.body.style[e] ? (k = e, !1) : !0
                    }), window.onresize = s, i(), s(f), t(this).on("carouselNext", function (t, e) {
                        void 0 === e && (e = 1), _ = f + v * e, f !== _ && (C = _ - f, E = Date.now(), requestAnimationFrame(l))
        ...
        function r(e) {
            if (o(), "string" == typeof e && (e = document.querySelector(e)), e && "object" == typeof e && e.nodeType) {
                ...
                var g = a.paddingLeft + a.paddingRight,
                    ...
                    x = c && s,
                    C = t(r.width);
                C !== !1 && (a.width = C + (x ? 0 : g + b));
                var _ = t(r.height);
                return _ !== !1 && (a.height = _ + (x ? 0 : m + w)), a.innerWidth = a.width - (g + b), a.innerHeight = a.height - (m + w), a.outerWidth = a.width + v, a.outerHeight = a.height + y, a
            }
        }
    ...
    function (t, e) {
        "function" == typeof define && define.amd ? define("outlayer/item", ["../../bower_components/ev-emitter/ev-emitter", "get-size/get-size"], function (i, n) {
            return e(t, i, n)
    ...
    function (t, e) {
        "use strict";
        "function" == typeof define && define.amd ? define("outlayer/outlayer", ["../../bower_components/ev-emitter/ev-emitter", "get-size/get-size", "fizzy-ui-utils/utils", "./item"], function (i, n, o, r) {
            return e(t, i, n, o, r)
    ...
    function (t, e) {
        ...
        o.Defaults = {
            ...
            return this.settings.freeDrag || t.each(s, t.proxy(function (t, a) {
                return e > a - o && a + o > e ? n = t : this.op(e, "<", a) && this.op(e, ">", s[t + 1] || a - r) && (n = "left" === i ? t + 1 : t), -1 === n
            ...
            return !t.isNumeric(e) || 1 > o ? e = n : (0 > e || e >= o + r) && (e = ((e - r / 2) % o + o) % o + r / 2), e
            ...
            if (i.loop) n = this._clones.length / 2 + this._items.length - 1;
                ...
                for (; n - r > 1;) Math.abs(this._coordinates[e = n + r >> 1]) < o ? r = e : n = e;
        ...
        t.ajaxChimp = {
            ...
            return t(this).each(function (i, n) {
                ...
                o.attr("novalidate", "true"), r.attr("name", "EMAIL"), o.submit(function () {
                    function e(e) {
                        if ("success" === e.result) i = "We have sent you a confirmation email", s.removeClass("error").addClass("valid"), r.removeClass("error").addClass("valid");
                        else {
                        ...
                        "en" !== a.language && void 0 !== t.ajaxChimp.responses[i] && t.ajaxChimp.translations && t.ajaxChimp.translations[a.language] && t.ajaxChimp.translations[a.language][t.ajaxChimp.responses[i]] && (i = t.ajaxChimp.translations[a.language][t.ajaxChimp.responses[i]]), s.html(i), s.show(2e3), a.callback && a.callback(e)
                    }
                    var i, n = {},
                        u = o.serializeArray();
...
App = {
    ...
    CONFIG: "undefined" === CONFIG ? console.error("Missing config file") : CONFIG,
    modal: function () {
    ...
    map: function () {
        function t(t) {
            var e = {
                ...
                scrollwheel: !1,
                draggable: App.GLOBAL.isTouch() ? !1 : !0
            };
            "undefined" !== t && (e.styles = t);
        ...
        $("#map").length > 0 && $.ajax({
            ...
            console.error("Map style configuration is missing:", e.statusText), console.warn("Loading map with default style"), t()
        })
    },
    contactForm: function (t) {
        ...
        o.on("click", function (t) {
            console.log("click"), t.preventDefault(), App._sendMessage(e, i, n, r, o)
        })
    },
    _sendMessage: function (t, e, i, n, o) {
        var r = App._verifyField(t, App.CONFIG.toastMessages.nameMissing),
            s = App._verifyField(e, App.CONFIG.toastMessages.contactMissing),
            a = App._verifyField(i, App.CONFIG.toastMessages.messageMissing, n);
        r && s && a && (App.GLOBAL.progress.show(), o.attr("disabled", !0), $.ajax({
            url: "/mailer/mailer.php",
            type: "POST",
            data: {
                name: t.html() || t.val(),
                contact: e.html() || e.val(),
                message: i.html() || i.val()
            }
        }).done(function (o) {
            1 == o ? (Materialize.toast(App.CONFIG.toastMessages.messageSent, App.CONFIG.toastSpeed, "success"), t.html("") && t.val(""), e.html("") && e.val(""), i.html(n) && i.val(n), t.next().removeClass("active"), e.next().removeClass("active"), i.next().removeClass("active")) : Materialize.toast(App.CONFIG.toastMessages.somethingWrong + o, App.CONFIG.toastSpeed, "error")
        }).error(function (t) {
            Materialize.toast(App.CONFIG.toastMessages.somethingWrong + t, App.CONFIG.toastSpeed, "error")
        }).complete(function () {
            App.GLOBAL.progress.hide(), o.attr("disabled", !1)
        }))
    },
    _verifyField: function (t, e, i) {
        var n, o = t.html() || t.val(),
            r = 0 === o.length;
        return n = "undefined" !== i ? r || o === i : r, "email" !== t.attr("type") || /.+\@.+\..+/.test(o) ? n ? (Materialize.toast(e, App.CONFIG.toastSpeed, "error", function () {
            App.GLOBAL.activeToasts--
        }), App.GLOBAL.activeToasts++, !1) : !0 : (Materialize.toast(App.CONFIG.toastMessages.enterValidEmail, App.CONFIG.toastSpeed, "error", function () {
            App.GLOBAL.activeToasts--
        }), App.GLOBAL.activeToasts++, !1)
    },
    ajaxChimp: function () {
        ...
        t.ajaxChimp({
            ...
            callback: function (e) {
                var i = e.msg,
                    n = e.result,
                    o = "success" === n ? 1e4 : 5e3;
                Materialize.toast(i.replace(/\d - /, ""), o, n), "success" === n && (t.find("input[type=email]").val(""), t.find("label").removeClass("active"))
            }
        })
    },
    loaded: function () {
        var t = $("body"),
            e = $(".spinner-container");
        t.addClass("locked"), $(window).on("load", function () {
            t.removeClass("locked"), e.addClass("hide-spinner"), setTimeout(function () {
                e.hide()
            }, 400)
        })
    }
}, $(document).ready(function () {
    App.modal(), App.collapsible(), App.scrollspy(), App.sideNav(), App.owl(), App.map(), $("#human-form").length ? App.contactForm("human") : $("#classic-form").length && App.contactForm("classic"), App.ajaxChimp(), App.loaded()
});
